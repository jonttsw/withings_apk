...
final class RetrofitDeviceRemoteRepository$createAssociation$2 extends w implements l<DeviceApi, y> {
    ...
    public RetrofitDeviceRemoteRepository$createAssociation$2(String str, String str2, String str3, String str4) {
        super(1);
    ...
    public final void invoke2(DeviceApi withApiForAccount) {
        ...
        withApiForAccount.createAssociation(this.$deviceSession, this.$timezone, this.$carrierCountryCode, this.$deviceCountryCode);
    }
}
