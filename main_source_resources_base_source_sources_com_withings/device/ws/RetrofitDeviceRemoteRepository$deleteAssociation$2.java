...
final class RetrofitDeviceRemoteRepository$deleteAssociation$2 extends w implements l<DeviceApi, y> {
    ...
    public RetrofitDeviceRemoteRepository$deleteAssociation$2(long j5, long j11, long j12) {
        super(1);
    ...
    public final void invoke2(DeviceApi withApiForAccount) {
        ...
        withApiForAccount.deleteAssociation(this.$associationId, this.$accountId, this.$deviceId);
    }
}
