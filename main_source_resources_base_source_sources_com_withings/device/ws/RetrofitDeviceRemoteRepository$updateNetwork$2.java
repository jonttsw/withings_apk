...
final class RetrofitDeviceRemoteRepository$updateNetwork$2 extends w implements l<DeviceApi, y> {
    final /* synthetic */ long $deviceId;
    final /* synthetic */ int $network;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitDeviceRemoteRepository$updateNetwork$2(long j5, int i11) {
        super(1);
        this.$deviceId = j5;
        this.$network = i11;
    }
    ...
    public final void invoke2(DeviceApi withApiForAccount) {
        ...
        withApiForAccount.updateNetwork(this.$deviceId, this.$network);
    }
}
