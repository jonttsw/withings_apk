...
final class RetrofitDeviceRemoteRepository$getAssociations$2 extends w implements l<DeviceApi, Associations> {
    final /* synthetic */ String $enrich;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitDeviceRemoteRepository$getAssociations$2(String str) {
        super(1);
        this.$enrich = str;
    }
    ...
    public final Associations invoke(DeviceApi withApiForAccount) {
        ...
        return withApiForAccount.getAssociations(this.$enrich);
    }
}
