...
final class RetrofitDeviceRemoteRepository$resetDevice$2 extends w implements l<DeviceApi, y> {
    final /* synthetic */ long $deviceId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitDeviceRemoteRepository$resetDevice$2(long j5) {
        super(1);
        this.$deviceId = j5;
    }
    ...
    public final void invoke2(DeviceApi withApiForAccount) {
        ...
        withApiForAccount.resetDevice(this.$deviceId);
    }
}
