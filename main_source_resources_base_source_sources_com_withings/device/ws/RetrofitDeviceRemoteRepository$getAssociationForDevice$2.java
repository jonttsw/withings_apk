...
final class RetrofitDeviceRemoteRepository$getAssociationForDevice$2 extends w implements l<DeviceApi, Associations> {
    final /* synthetic */ long $deviceId;
    final /* synthetic */ String $enrich;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitDeviceRemoteRepository$getAssociationForDevice$2(long j5, String str) {
        super(1);
        this.$deviceId = j5;
        this.$enrich = str;
    }
    ...
    public final Associations invoke(DeviceApi withApiForAccount) {
        ...
        return withApiForAccount.getAssociationForDevice(this.$deviceId, this.$enrich);
    }
}
