...
public final class r extends kotlin.jvm.internal.w implements ym0.p<androidx.compose.runtime.a, Integer, nm0.y> {
    ...
    final /* synthetic */ AutomaticActivityDetection f36727a;
    ...
    public r(AutomaticActivityDetection automaticActivityDetection, int i11) {
        super(2);
        this.f36727a = automaticActivityDetection;
        this.f36728b = i11;
    }
    ...
    public final nm0.y invoke(androidx.compose.runtime.a aVar, Integer num) {
        num.intValue();
        int g11 = ah.o.g(this.f36728b | 1);
        AutomaticActivityDetection.B3(this.f36727a, aVar, g11);
