...
public final class e implements GpsLocationMapView.b {
    ...
    public final void a(Context context) {
        this.f62980a = androidx.core.content.a.getColor(context, 17170443);
    }
    ...
    public final void c(ProviderMapView mapView, List<GpsLocation> locations, GpsLocationsSummary gpsLocationsSummary) {
        ...
        mapView.d(locations, this.f62980a, 10.0f);
    }
}
