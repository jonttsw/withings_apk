...
final class RetrofitEcgReviewRemoteRepository$sendCode$2 extends w implements l<EcgReviewRetrofit1Api, y> {
    ...
    public RetrofitEcgReviewRemoteRepository$sendCode$2(long j5, long j11, String str) {
        super(1);
        this.$userId = j5;
        this.$deviceId = j11;
    ...
    public final void invoke2(EcgReviewRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.sendCode(this.$userId, this.$deviceId, this.$phoneNumber);
    }
}
