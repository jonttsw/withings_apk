...
final class j0 extends kotlin.jvm.internal.w implements ym0.l<EcgLeadType, List<EcgEntry>> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Map<EcgLeadType, List<EcgEntry>> f38242a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j0(Map<EcgLeadType, List<EcgEntry>> map) {
        super(1);
        this.f38242a = map;
    }
    ...
    public final List<EcgEntry> invoke(EcgLeadType ecgLeadType) {
        ...
        List<EcgEntry> list = this.f38242a.get(ecgLeadType2);
        if (list == null) {
