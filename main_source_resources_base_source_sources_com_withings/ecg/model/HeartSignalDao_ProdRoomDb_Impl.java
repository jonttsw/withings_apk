...
public final class HeartSignalDao_ProdRoomDb_Impl implements HeartSignalDao {
    ...
    public HeartSignalDao_ProdRoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfHeartSignalMeasurement = new k<HeartSignalMeasurement>(roomDatabase) { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.1
            ...
            public void bind(f fVar, HeartSignalMeasurement heartSignalMeasurement) {
                ...
                b bVar = HeartSignalDao_ProdRoomDb_Impl.this.__commonRoomConverter;
                ...
                c cVar = HeartSignalDao_ProdRoomDb_Impl.this.__roomConverters;
        ...
        this.__updateAdapterOfHeartSignalMeasurement = new j<HeartSignalMeasurement>(roomDatabase) { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.2
        ...
        this.__preparedStmtOfDelete = new h0(roomDatabase) { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.3
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM EcgMeasurement where id= ?";
            }
        };
        this.__preparedStmtOfDeleteAll = new h0(roomDatabase) { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.4
            @Override // androidx.room.h0
            public String createQuery() {
    ...
    public Flow<HeartSignalMeasurement> getByTimestampAndTypeFlow(long j5, long j11, int... iArr) {
        ...
        return g.a(this.__db, false, new String[]{"EcgMeasurement"}, new Callable<HeartSignalMeasurement>() { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.6
            ...
            public HeartSignalMeasurement call() throws Exception {
                Cursor c13 = x8.b.c(HeartSignalDao_ProdRoomDb_Impl.this.__db, c12, false);
                try {
                    int b10 = a.b(c13, "id");
                    int b11 = a.b(c13, "userID");
                    int b12 = a.b(c13, "deviceModel");
                    ...
                    if (c13.moveToFirst()) {
                        ...
                        HeartSignalDao_ProdRoomDb_Impl.this.__commonRoomConverter.getClass();
                        DateTime a11 = b.a(valueOf);
                        if (a11 != null) {
                            ...
                            String string = c13.getString(b19);
                            HeartSignalDao_ProdRoomDb_Impl.this.__roomConverters.getClass();
    ...
    public Flow<HeartSignalMeasurement> getContinuousLastHeartSignal(long j5, int... iArr) {
        ...
        return g.a(this.__db, false, new String[]{"EcgMeasurement"}, new Callable<HeartSignalMeasurement>() { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.9
            protected void finalize() {
                c12.release();
            }
    ...
    public Flow<Integer> getCountAsFlow() {
        ...
        return g.a(this.__db, false, new String[]{"EcgMeasurement"}, new Callable<Integer>() { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.10
            protected void finalize() {
                c11.release();
            }
            ...
            public Integer call() throws Exception {
                int i11;
                Cursor c12 = x8.b.c(HeartSignalDao_ProdRoomDb_Impl.this.__db, c11, false);
                try {
                    if (c12.moveToFirst()) {
    ...
    public LiveData<HeartSignalMeasurement> getHeartSignalLiveData(long j5) {
        ...
        c11.v(1, j5);
        return this.__db.l().c(new String[]{"EcgMeasurement"}, new Callable<HeartSignalMeasurement>() { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.8
            protected void finalize() {
                c11.release();
            }
    ...
    public List<HeartSignalMeasurement> getNotSyncedSignalsForUser(long j5) {
        ...
        Integer valueOf5;
        int i12;
        HeartSignalDao_ProdRoomDb_Impl heartSignalDao_ProdRoomDb_Impl = this;
        d0 c11 = d0.c(1, "SELECT * from EcgMeasurement where userId = ? AND Not synced");
        c11.v(1, j5);
        heartSignalDao_ProdRoomDb_Impl.__db.b();
        Cursor c12 = x8.b.c(heartSignalDao_ProdRoomDb_Impl.__db, c11, false);
        try {
            int b10 = a.b(c12, "id");
            int b11 = a.b(c12, "userID");
            int b12 = a.b(c12, "deviceModel");
            ...
            try {
                ...
                while (c12.moveToNext()) {
                    ...
                    heartSignalDao_ProdRoomDb_Impl.__commonRoomConverter.getClass();
                    DateTime a11 = b.a(valueOf);
                    if (a11 != null) {
                        if (c12.getInt(b14) != 0) {
                            z5 = true;
                        ...
                        String string = c12.getString(b19);
                        heartSignalDao_ProdRoomDb_Impl.__roomConverters.getClass();
                        List c13 = c.c(string);
                        if (c12.isNull(b21)) {
                            valueOf4 = null;
                        } else {
                        ...
                        heartSignalDao_ProdRoomDb_Impl = this;
                        b10 = i11;
                        b22 = b22;
                    } else {
                        throw new IllegalStateException("Expected NON-NULL 'org.joda.time.DateTime', but it was NULL.");
    ...
    public List<HeartSignalMeasurement> getSignalsWithType(long j5, int... iArr) {
        ...
        heartSignalDao_ProdRoomDb_Impl.__db.b();
        Cursor c13 = x8.b.c(heartSignalDao_ProdRoomDb_Impl.__db, c12, false);
        try {
            int b10 = a.b(c13, "id");
            int b11 = a.b(c13, "userID");
            int b12 = a.b(c13, "deviceModel");
    ...
    public Flow<List<HeartSignalMeasurement>> getSignalsWithTypeFlow(long j5, int... iArr) {
        ...
        return g.a(this.__db, false, new String[]{"EcgMeasurement"}, new Callable<List<HeartSignalMeasurement>>() { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.5
            protected void finalize() {
                c12.release();
            }
    ...
    public LiveData<List<HeartSignalMeasurement>> getSignalsWithTypeLiveData(long j5, int... iArr) {
        ...
        return this.__db.l().c(new String[]{"EcgMeasurement"}, new Callable<List<HeartSignalMeasurement>>() { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.7
            protected void finalize() {
                c12.release();
            }
    ...
    public Flow<Integer> getCountAsFlow(long j5) {
        ...
        c11.v(1, j5);
        return g.a(this.__db, false, new String[]{"EcgMeasurement"}, new Callable<Integer>() { // from class: com.withings.ecg.model.HeartSignalDao_ProdRoomDb_Impl.11
            protected void finalize() {
                c11.release();
            }
