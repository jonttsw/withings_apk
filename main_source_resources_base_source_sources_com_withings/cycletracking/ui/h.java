...
final class h extends kotlin.jvm.internal.w implements ym0.l<androidx.navigation.c, nm0.y> {
    ...
    final /* synthetic */ CycleTrackingActivity f35576a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(CycleTrackingActivity cycleTrackingActivity) {
        super(1);
        this.f35576a = cycleTrackingActivity;
    }
