...
final class RetrofitAccountRemoteRepository$requestNewPassword$2 extends w implements l<AccountRetrofit1Api, y> {
    final /* synthetic */ String $email;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitAccountRemoteRepository$requestNewPassword$2(String str) {
        super(1);
        this.$email = str;
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApi) {
        ...
        withApi.requestNewPassword(this.$email, "password");
    }
}
