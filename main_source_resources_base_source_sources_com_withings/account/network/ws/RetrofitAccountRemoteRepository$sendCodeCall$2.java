...
final class RetrofitAccountRemoteRepository$sendCodeCall$2 extends w implements l<AccountRetrofit1Api, y> {
    public static final RetrofitAccountRemoteRepository$sendCodeCall$2 INSTANCE = new RetrofitAccountRemoteRepository$sendCodeCall$2();

    RetrofitAccountRemoteRepository$sendCodeCall$2() {
        super(1);
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.sendCode(RetrofitAccountRemoteRepository.CHANNEL_CALL);
    }
}
