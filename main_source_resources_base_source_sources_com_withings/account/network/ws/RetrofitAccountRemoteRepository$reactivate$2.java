...
final class RetrofitAccountRemoteRepository$reactivate$2 extends w implements l<AccountRetrofit1Api, y> {
    final /* synthetic */ long $accountId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitAccountRemoteRepository$reactivate$2(long j5) {
        super(1);
        this.$accountId = j5;
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.reactivate(this.$accountId);
    }
}
