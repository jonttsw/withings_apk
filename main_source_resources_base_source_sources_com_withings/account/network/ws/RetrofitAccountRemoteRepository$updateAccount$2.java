...
final class RetrofitAccountRemoteRepository$updateAccount$2 extends w implements l<AccountRetrofit1Api, y> {
    ...
    public RetrofitAccountRemoteRepository$updateAccount$2(long j5, String str, String str2) {
        super(1);
        this.$accountId = j5;
        this.$timezone = str;
        this.$language = str2;
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.updateAccount(this.$accountId, this.$timezone, this.$language);
    }
}
