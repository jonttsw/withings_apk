...
final class RetrofitAccountRemoteRepository$updateAccountContext$2 extends w implements l<AccountRetrofit1Api, y> {
    final /* synthetic */ long $accountId;
    final /* synthetic */ String $contextStr;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitAccountRemoteRepository$updateAccountContext$2(long j5, String str) {
        super(1);
        this.$accountId = j5;
        this.$contextStr = str;
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.updateAccountContext(j5, contextStr, 20);
    }
}
