...
final class RetrofitAccountRemoteRepository$deleteCall$2 extends w implements l<AccountRetrofit1Api, y> {
    public static final RetrofitAccountRemoteRepository$deleteCall$2 INSTANCE = new RetrofitAccountRemoteRepository$deleteCall$2();

    RetrofitAccountRemoteRepository$deleteCall$2() {
        super(1);
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.deletePhone(RetrofitAccountRemoteRepository.CHANNEL_CALL);
    }
}
