...
final class RetrofitSessionRemoteRepository$renewWithRecoveryCode$2 extends w implements l<SessionRetrofit1Api, RenewResponse> {
    ...
    public RetrofitSessionRemoteRepository$renewWithRecoveryCode$2(String str, String str2, String str3, String str4, String str5) {
        super(1);
        this.$sessionId = str;
        this.$code = str2;
        this.$modelName = str3;
    ...
    public final RenewResponse invoke(SessionRetrofit1Api withApi) {
        ...
        return withApi.renewWithRecoveryCode(this.$sessionId, this.$code, false, this.$modelName, this.$typeName, this.$os);
    }
}
