...
final class RetrofitAccountRemoteRepository$sendCodeSms$2 extends w implements l<AccountRetrofit1Api, y> {
    public static final RetrofitAccountRemoteRepository$sendCodeSms$2 INSTANCE = new RetrofitAccountRemoteRepository$sendCodeSms$2();

    RetrofitAccountRemoteRepository$sendCodeSms$2() {
        super(1);
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.sendCode("sms");
    }
}
