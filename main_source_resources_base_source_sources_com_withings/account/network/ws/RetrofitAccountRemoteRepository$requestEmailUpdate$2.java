...
final class RetrofitAccountRemoteRepository$requestEmailUpdate$2 extends w implements l<AccountRetrofit1Api, y> {
    final /* synthetic */ int $accountId;
    final /* synthetic */ String $email;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitAccountRemoteRepository$requestEmailUpdate$2(int i11, String str) {
        super(1);
        this.$accountId = i11;
        this.$email = str;
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.requestEmailUpdate(this.$accountId, this.$email);
    }
}
