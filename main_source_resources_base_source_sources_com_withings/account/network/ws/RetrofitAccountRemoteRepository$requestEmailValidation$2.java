...
final class RetrofitAccountRemoteRepository$requestEmailValidation$2 extends w implements l<AccountRetrofit1Api, y> {
    public static final RetrofitAccountRemoteRepository$requestEmailValidation$2 INSTANCE = new RetrofitAccountRemoteRepository$requestEmailValidation$2();

    RetrofitAccountRemoteRepository$requestEmailValidation$2() {
        super(1);
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.requestEmailValidation();
    }
}
