...
final class RetrofitAccountRemoteRepository$deleteSms$2 extends w implements l<AccountRetrofit1Api, y> {
    public static final RetrofitAccountRemoteRepository$deleteSms$2 INSTANCE = new RetrofitAccountRemoteRepository$deleteSms$2();

    RetrofitAccountRemoteRepository$deleteSms$2() {
        super(1);
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.deletePhone("sms");
    }
}
