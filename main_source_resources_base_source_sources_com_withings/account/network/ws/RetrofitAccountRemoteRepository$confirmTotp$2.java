...
final class RetrofitAccountRemoteRepository$confirmTotp$2 extends w implements l<AccountRetrofit1Api, y> {
    final /* synthetic */ String $code;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitAccountRemoteRepository$confirmTotp$2(String str) {
        super(1);
        this.$code = str;
    }
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.confirmTotp(this.$code);
    }
}
