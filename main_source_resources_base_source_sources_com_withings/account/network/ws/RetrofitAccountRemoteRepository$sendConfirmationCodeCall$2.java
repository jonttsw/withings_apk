...
final class RetrofitAccountRemoteRepository$sendConfirmationCodeCall$2 extends w implements l<AccountRetrofit1Api, y> {
    final /* synthetic */ String $phoneNumber;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitAccountRemoteRepository$sendConfirmationCodeCall$2(String str) {
        super(1);
    ...
    public final void invoke2(AccountRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.sendConfirmationCode(RetrofitAccountRemoteRepository.CHANNEL_CALL, this.$phoneNumber);
    }
}
