...
final class SectionArticlesPage$popularQuestionAdapter$2 extends w implements ym0.a<PopularQuestionAdapter> {
    ...
    /* renamed from: com.withings.zendesk.ui.SectionArticlesPage$popularQuestionAdapter$2$1  reason: invalid class name */
    /* loaded from: classes5.dex */
    public static final class AnonymousClass1 extends w implements l<SimpleArticle, y> {
        final /* synthetic */ SectionArticlesPage this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(SectionArticlesPage sectionArticlesPage) {
            super(1);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SectionArticlesPage$popularQuestionAdapter$2(SectionArticlesPage sectionArticlesPage) {
        super(0);
        this.this$0 = sectionArticlesPage;
    }
