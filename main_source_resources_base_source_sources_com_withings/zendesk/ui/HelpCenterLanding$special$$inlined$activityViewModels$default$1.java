...
public final class HelpCenterLanding$special$$inlined$activityViewModels$default$1 extends w implements ym0.a<m1> {
    final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HelpCenterLanding$special$$inlined$activityViewModels$default$1(Fragment fragment) {
        super(0);
