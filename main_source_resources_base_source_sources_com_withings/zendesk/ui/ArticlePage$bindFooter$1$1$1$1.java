...
public final class ArticlePage$bindFooter$1$1$1$1 extends w implements l<Article, y> {
    final /* synthetic */ ArticlePage this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ArticlePage$bindFooter$1$1$1$1(ArticlePage articlePage) {
        super(1);
    ...
    public final void invoke2(Article article) {
        u.j(article, "article");
        this.this$0.onArticleClicked(article);
    }
}
