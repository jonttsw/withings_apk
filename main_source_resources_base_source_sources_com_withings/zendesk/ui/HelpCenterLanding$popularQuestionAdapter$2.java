...
final class HelpCenterLanding$popularQuestionAdapter$2 extends w implements ym0.a<PopularQuestionAdapter> {
    ...
    /* renamed from: com.withings.zendesk.ui.HelpCenterLanding$popularQuestionAdapter$2$1  reason: invalid class name */
    /* loaded from: classes5.dex */
    public static final class AnonymousClass1 extends w implements l<SimpleArticle, y> {
        final /* synthetic */ HelpCenterLanding this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(HelpCenterLanding helpCenterLanding) {
            super(1);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HelpCenterLanding$popularQuestionAdapter$2(HelpCenterLanding helpCenterLanding) {
        super(0);
        this.this$0 = helpCenterLanding;
    }
