...
public final class PatientSessionDao_ProdRoomDb_Impl implements PatientSessionDao {
    private final RoomDatabase __db;
    private final j<PatientSessionEntity> __updateAdapterOfPatientSessionEntity;

    public PatientSessionDao_ProdRoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__updateAdapterOfPatientSessionEntity = new j<PatientSessionEntity>(roomDatabase) { // from class: com.withings.clinicalstudy.repository.PatientSessionDao_ProdRoomDb_Impl.1
