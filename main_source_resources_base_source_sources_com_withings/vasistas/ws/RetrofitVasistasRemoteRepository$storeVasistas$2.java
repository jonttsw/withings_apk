...
final class RetrofitVasistasRemoteRepository$storeVasistas$2 extends w implements ym0.l<VasistasRetrofit1Api, y> {
    ...
    public RetrofitVasistasRemoteRepository$storeVasistas$2(long j5, String str, String str2) {
        super(1);
        this.$userId = j5;
        this.$category = str;
    ...
    public final void invoke2(VasistasRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.storeVasistas(this.$userId, this.$category, this.$vasistasSerie);
    }
}
