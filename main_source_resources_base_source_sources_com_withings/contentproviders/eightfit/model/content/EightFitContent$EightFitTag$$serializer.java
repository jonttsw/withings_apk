...
public final class EightFitContent$EightFitTag$$serializer implements GeneratedSerializer<EightFitContent.EightFitTag> {
    public static final EightFitContent$EightFitTag$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        EightFitContent$EightFitTag$$serializer eightFitContent$EightFitTag$$serializer = new EightFitContent$EightFitTag$$serializer();
        INSTANCE = eightFitContent$EightFitTag$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.withings.contentproviders.eightfit.model.content.EightFitContent.EightFitTag", eightFitContent$EightFitTag$$serializer, 3);
    ...
    private EightFitContent$EightFitTag$$serializer() {
    }
    ...
    public EightFitContent.EightFitTag deserialize(Decoder decoder) {
        int i11;
        String str;
        String str2;
        String str3;
        ...
        return new EightFitContent.EightFitTag(i11, str, str2, str3, null);
    }
    ...
    public void serialize(Encoder encoder, EightFitContent.EightFitTag value) {
        u.j(encoder, "encoder");
        u.j(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        EightFitContent.EightFitTag.write$Self$eightfit_release(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
