...
public final class WsContentDeserializerClass implements JsonDeserializer<WsContent> {
    ...
    public WsContent deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) {
        ...
        do {
            ...
            if (jsonElement != null) {
                associatedWsClass = WsContentDeserializerKt.associatedWsClass(taskType);
                wsContent = (WsContent) context.deserialize(jsonElement, associatedWsClass);
                continue;
            }
