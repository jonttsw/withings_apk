...
public final class PlatformFeatureDao_RoomDb_Impl implements PlatformFeatureDao {
    ...
    public PlatformFeatureDao_RoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfPlatformFeature = new k<PlatformFeature>(roomDatabase) { // from class: com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl.1
            ...
            public void bind(f fVar, PlatformFeature platformFeature) {
                ...
                fVar.s(3, PlatformFeatureDao_RoomDb_Impl.this.__featureRoomConverter.ownersToString(platformFeature.getOwners()));
                fVar.v(4, platformFeature.getSynced() ? 1L : 0L);
            }
        };
        this.__updateAdapterOfPlatformFeature = new j<PlatformFeature>(roomDatabase) { // from class: com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl.2
        ...
        this.__preparedStmtOfClear = new h0(roomDatabase) { // from class: com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl.3
            @Override // androidx.room.h0
    ...
    public Flow<List<PlatformFeature>> getAllPlatformFeaturesFlow() {
        ...
        return g.a(this.__db, false, new String[]{"PlatformFeature"}, new Callable<List<PlatformFeature>>() { // from class: com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl.5
            ...
            public List<PlatformFeature> call() throws Exception {
                Cursor c12 = b.c(PlatformFeatureDao_RoomDb_Impl.this.__db, c11, false);
                try {
                    int b10 = a.b(c12, "featureId");
                    int b11 = a.b(c12, "name");
                    int b12 = a.b(c12, "owners");
                    ...
                    ArrayList arrayList = new ArrayList(c12.getCount());
                    while (c12.moveToNext()) {
                        arrayList.add(new PlatformFeature(c12.getInt(b10), c12.isNull(b11) ? null : c12.getString(b11), PlatformFeatureDao_RoomDb_Impl.this.__featureRoomConverter.stringToOwners(c12.getString(b12)), c12.getInt(b13) != 0));
                    }
                    return arrayList;
                } finally {
                    c12.close();
    ...
    public LiveData<List<PlatformFeature>> getAllPlatformFeaturesLiveData() {
        final d0 c11 = d0.c(0, "select * from PlatformFeature");
        return this.__db.l().c(new String[]{"PlatformFeature"}, new Callable<List<PlatformFeature>>() { // from class: com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl.4
            protected void finalize() {
                c11.release();
            }
    ...
    public Flow<PlatformFeature> getFeatureAsFlow(int i11) {
        ...
        c11.v(1, i11);
        return g.a(this.__db, false, new String[]{"PlatformFeature"}, new Callable<PlatformFeature>() { // from class: com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl.6
            protected void finalize() {
                c11.release();
            }
            ...
            public PlatformFeature call() throws Exception {
                ...
                try {
                    ...
                    if (c12.moveToFirst()) {
                        ...
                        platformFeature = new PlatformFeature(i12, string, PlatformFeatureDao_RoomDb_Impl.this.__featureRoomConverter.stringToOwners(c12.getString(b12)), c12.getInt(b13) != 0);
                    }
                    return platformFeature;
                } finally {
                    c12.close();
    ...
    public LiveData<PlatformFeature> getFeatureLiveData(int i11) {
        final d0 c11 = d0.c(1, "select * from PlatformFeature where featureId =?");
        c11.v(1, i11);
        return this.__db.l().c(new String[]{"PlatformFeature"}, new Callable<PlatformFeature>() { // from class: com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl.7
            protected void finalize() {
                c11.release();
            }
