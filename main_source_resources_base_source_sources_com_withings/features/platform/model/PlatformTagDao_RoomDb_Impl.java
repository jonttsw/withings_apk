...
public final class PlatformTagDao_RoomDb_Impl implements PlatformTagDao {
    ...
    public PlatformTagDao_RoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfTag = new k<Tag>(roomDatabase) { // from class: com.withings.features.platform.model.PlatformTagDao_RoomDb_Impl.1
            ...
            public void bind(f fVar, Tag tag) {
                ...
                b bVar = PlatformTagDao_RoomDb_Impl.this.__commonRoomConverter;
                List<String> tags = tag.getTags();
                bVar.getClass();
                fVar.s(3, b.b(tags));
            }
        };
        this.__preparedStmtOfClear = new h0(roomDatabase) { // from class: com.withings.features.platform.model.PlatformTagDao_RoomDb_Impl.2
            @Override // androidx.room.h0
