...
public final class SyncPlatformFeature$getFeaturesWithoutConflicts$1$2$1$1 extends w implements l<Owner, Boolean> {
    final /* synthetic */ PlatformFeature $notSyncedFeature;
    final /* synthetic */ SyncPlatformFeature this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SyncPlatformFeature$getFeaturesWithoutConflicts$1$2$1$1(SyncPlatformFeature syncPlatformFeature, PlatformFeature platformFeature) {
        super(1);
        this.this$0 = syncPlatformFeature;
        this.$notSyncedFeature = platformFeature;
    }
    ...
    public final Boolean invoke(Owner it) {
        ...
        u.j(it, "it");
        hasOwnerOverrideByAny = this.this$0.hasOwnerOverrideByAny(it, this.$notSyncedFeature.getOwners());
