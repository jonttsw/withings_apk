...
final class SyncPlatformFeature$getFeaturesWithoutConflicts$2 extends w implements l<PlatformFeature, Boolean> {
    public static final SyncPlatformFeature$getFeaturesWithoutConflicts$2 INSTANCE = new SyncPlatformFeature$getFeaturesWithoutConflicts$2();

    SyncPlatformFeature$getFeaturesWithoutConflicts$2() {
        super(1);
    }
