...
public final class NoteGroupDao_ProdRoomDb_Impl implements NoteGroupDao {
    ...
    public NoteGroupDao_ProdRoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfNoteGroupAsRoomNoteGroup = new k<NoteGroup>(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.1
            ...
            public void bind(f fVar, NoteGroup noteGroup) {
                ...
                b bVar = NoteGroupDao_ProdRoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar2 = NoteGroupDao_ProdRoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar3 = NoteGroupDao_ProdRoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar4 = NoteGroupDao_ProdRoomDb_Impl.this.__commonRoomConverter;
        ...
        this.__insertionAdapterOfNoteEntityAsRoomNote = new k<NoteEntity>(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.2
            @Override // androidx.room.h0
            protected String createQuery() {
        ...
        this.__deletionAdapterOfNoteGroupAsRoomNoteGroup = new j<NoteGroup>(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.3
        ...
        this.__updateAdapterOfNoteGroupAsRoomNoteGroup = new j<NoteGroup>(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.4
            @Override // androidx.room.j, androidx.room.h0
            protected String createQuery() {
        ...
        this.__updateAdapterOfNoteEntityAsRoomNote = new j<NoteEntity>(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.5
            @Override // androidx.room.j, androidx.room.h0
            protected String createQuery() {
        ...
        this.__preparedStmtOfUpdateSignalId = new h0(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.6
            @Override // androidx.room.h0
            public String createQuery() {
                return "UPDATE NoteEntity SET signalId = ? WHERE localNoteGroupId= ?";
            }
        };
        this.__preparedStmtOfDeleteNote = new h0(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.7
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM NoteEntity WHERE noteId = ?";
            }
        };
        this.__preparedStmtOfDeleteAllNotesForNotegroupId = new h0(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.8
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM NoteEntity WHERE localNoteGroupId = ?";
            }
        };
        this.__preparedStmtOfDeleteAll = new h0(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.9
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM NoteGroup";
            }
        };
        this.__preparedStmtOfDeleteAllNotes = new h0(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.10
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM NoteEntity";
            }
        };
        this.__preparedStmtOfUpdateNoteGroupsWithMeasureIds = new h0(roomDatabase) { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.11
            @Override // androidx.room.h0
            public String createQuery() {
    ...
    public LiveData<NoteGroup> getLocalLiveDataBySignalId(long j5) {
        ...
        c11.v(1, j5);
        return this.__db.l().c(new String[]{"NoteGroup"}, new Callable<NoteGroup>() { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.12
            ...
            public NoteGroup call() throws Exception {
                Cursor c12 = x8.b.c(NoteGroupDao_ProdRoomDb_Impl.this.__db, c11, false);
                try {
                    int b10 = a.b(c12, "noteGroupId");
                    int b11 = a.b(c12, "wsId");
                    int b12 = a.b(c12, NavigationArguments.USER_ID);
                    ...
                    if (c12.moveToFirst()) {
                        ...
                        NoteGroupDao_ProdRoomDb_Impl.this.__commonRoomConverter.getClass();
    ...
    public LiveData<List<NoteGroup>> getNoteGroupLiveDataForMeasureGroupDbId(long j5) {
        ...
        c11.v(1, j5);
        return this.__db.l().c(new String[]{"NoteGroup"}, new Callable<List<NoteGroup>>() { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.15
            protected void finalize() {
                c11.release();
            }
    ...
    public LiveData<List<NoteGroup>> getNoteGroupLiveDataForMeasureGroupWsId(long j5) {
        ...
        c11.v(1, j5);
        return this.__db.l().c(new String[]{"NoteGroup"}, new Callable<List<NoteGroup>>() { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.14
            protected void finalize() {
                c11.release();
            }
    ...
    public LiveData<NoteGroup> getRemoteLiveDataBySignalId(long j5) {
        ...
        c11.v(1, j5);
        return this.__db.l().c(new String[]{"NoteGroup"}, new Callable<NoteGroup>() { // from class: com.withings.note.model.NoteGroupDao_ProdRoomDb_Impl.13
            protected void finalize() {
                c11.release();
            }
