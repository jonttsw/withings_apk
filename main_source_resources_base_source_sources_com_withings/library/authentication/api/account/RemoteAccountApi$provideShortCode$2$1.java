...
final class RemoteAccountApi$provideShortCode$2$1 extends w implements p<f0, f0, y> {
    public static final RemoteAccountApi$provideShortCode$2$1 INSTANCE = new RemoteAccountApi$provideShortCode$2$1();

    RemoteAccountApi$provideShortCode$2$1() {
        super(2);
    }
