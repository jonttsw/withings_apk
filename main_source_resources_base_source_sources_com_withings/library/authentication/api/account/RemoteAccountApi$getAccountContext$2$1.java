...
final class RemoteAccountApi$getAccountContext$2$1 extends w implements p<f0, f0, y> {
    public static final RemoteAccountApi$getAccountContext$2$1 INSTANCE = new RemoteAccountApi$getAccountContext$2$1();

    RemoteAccountApi$getAccountContext$2$1() {
        super(2);
    }
