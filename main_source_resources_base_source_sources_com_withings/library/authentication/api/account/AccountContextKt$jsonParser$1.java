...
final class AccountContextKt$jsonParser$1 extends w implements l<JsonBuilder, y> {
    public static final AccountContextKt$jsonParser$1 INSTANCE = new AccountContextKt$jsonParser$1();

    AccountContextKt$jsonParser$1() {
        super(1);
    }
