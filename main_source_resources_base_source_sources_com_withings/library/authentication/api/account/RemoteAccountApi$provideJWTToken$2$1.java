...
final class RemoteAccountApi$provideJWTToken$2$1 extends w implements p<f0, f0, y> {
    public static final RemoteAccountApi$provideJWTToken$2$1 INSTANCE = new RemoteAccountApi$provideJWTToken$2$1();

    RemoteAccountApi$provideJWTToken$2$1() {
        super(2);
    }
