...
public final class AccountContextResponse$$serializer implements GeneratedSerializer<AccountContextResponse> {
    public static final AccountContextResponse$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        AccountContextResponse$$serializer accountContextResponse$$serializer = new AccountContextResponse$$serializer();
        INSTANCE = accountContextResponse$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.withings.library.authentication.api.account.AccountContextResponse", accountContextResponse$$serializer, 1);
        pluginGeneratedSerialDescriptor.addElement("account", false);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private AccountContextResponse$$serializer() {
    }

    @Override // kotlinx.serialization.internal.GeneratedSerializer
    public KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr;
        kSerializerArr = AccountContextResponse.$childSerializers;
        return new KSerializer[]{kSerializerArr[0]};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    public AccountContextResponse deserialize(Decoder decoder) {
        KSerializer[] kSerializerArr;
        List list;
        u.j(decoder, "decoder");
        ...
        return new AccountContextResponse(i11, list, null);
    }
    ...
    public void serialize(Encoder encoder, AccountContextResponse value) {
        u.j(encoder, "encoder");
        u.j(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        beginStructure.encodeSerializableElement(descriptor2, 0, AccountContextResponse.$childSerializers[0], value.account);
        beginStructure.endStructure(descriptor2);
    }
