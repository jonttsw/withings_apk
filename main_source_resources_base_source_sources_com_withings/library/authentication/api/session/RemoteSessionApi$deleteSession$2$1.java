...
final class RemoteSessionApi$deleteSession$2$1 extends w implements p<f0, f0, y> {
    public static final RemoteSessionApi$deleteSession$2$1 INSTANCE = new RemoteSessionApi$deleteSession$2$1();

    RemoteSessionApi$deleteSession$2$1() {
        super(2);
    }
    ...
    public final void invoke2(f0 url, f0 it) {
        u.j(url, "$this$url");
        u.j(it, "it");
        g0.d(url, "/session?action=delete");
    }
