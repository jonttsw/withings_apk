...
final class RemoteAuthApi$loginFromAuthProvider$2$1 extends w implements p<f0, f0, y> {
    public static final RemoteAuthApi$loginFromAuthProvider$2$1 INSTANCE = new RemoteAuthApi$loginFromAuthProvider$2$1();

    RemoteAuthApi$loginFromAuthProvider$2$1() {
        super(2);
    }
