...
final class RemoteAuthApi$logout$2$1 extends w implements p<f0, f0, y> {
    public static final RemoteAuthApi$logout$2$1 INSTANCE = new RemoteAuthApi$logout$2$1();

    RemoteAuthApi$logout$2$1() {
        super(2);
    }
