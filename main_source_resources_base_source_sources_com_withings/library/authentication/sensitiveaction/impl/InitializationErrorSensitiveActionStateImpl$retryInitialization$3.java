...
final class InitializationErrorSensitiveActionStateImpl$retryInitialization$3 extends w implements a<Server> {
    final /* synthetic */ Session $authSession;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InitializationErrorSensitiveActionStateImpl$retryInitialization$3(Session session) {
        super(0);
