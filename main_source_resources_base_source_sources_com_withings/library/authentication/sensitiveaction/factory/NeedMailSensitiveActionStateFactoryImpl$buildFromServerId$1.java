...
final class NeedMailSensitiveActionStateFactoryImpl$buildFromServerId$1 extends w implements a<Server> {
    final /* synthetic */ int $serverId;
    final /* synthetic */ NeedMailSensitiveActionStateFactoryImpl this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NeedMailSensitiveActionStateFactoryImpl$buildFromServerId$1(NeedMailSensitiveActionStateFactoryImpl needMailSensitiveActionStateFactoryImpl, int i11) {
        super(0);
        this.this$0 = needMailSensitiveActionStateFactoryImpl;
        this.$serverId = i11;
    }
