...
/* compiled from: Unregistered2FASetupFactory.kt */
...
public interface Unregistered2FASetupFactory {
    Unregistered2FASetup build(com.withings.library.authentication.login.Session session);

    Unregistered2FASetup buildWithRepo(com.withings.library.authentication.login.Session session);

    Unregistered2FASetup buildWithRepo(Unregistered2FASetup unregistered2FASetup);
}
