...
public final class AttachmentNeedSmsResultImpl implements AttachmentNeedSmsResult, a {
    ...
    public Object injectCode(String str, d<? super AttachmentNeedSmsResult.CodeOutputState> dVar) {
        return new AttachmentNeedSmsResult.CodeOutputState.SuccessAttached(getAttachmentFinishedFactory().build());
    }

    @Override // com.withings.library.authentication.attachment.state.AttachmentNeedSmsResult
    public Object resendSms(d<? super AttachmentNeedSmsResult.SmsOutputState> dVar) {
        return new AttachmentNeedSmsResult.SmsOutputState.SuccessNeedSmsResult(this);
    }

    @Override // com.withings.library.authentication.attachment.state.AttachmentNeedSmsResult
    public Object switchToBirthdayVerification(d<? super AttachmentNeedSmsResult.SwitchMethodOutputState> dVar) {
        return new AttachmentNeedSmsResult.SwitchMethodOutputState.SuccessBirthdayVerification(getAttachmentBirthdayVerificationFactory().build());
    }
}
