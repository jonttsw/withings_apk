...
final class LoggedOutFactoryImpl$buildLoggedOutFromServerId$1 extends w implements a<Server> {
    final /* synthetic */ int $serverId;
    final /* synthetic */ LoggedOutFactoryImpl this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LoggedOutFactoryImpl$buildLoggedOutFromServerId$1(LoggedOutFactoryImpl loggedOutFactoryImpl, int i11) {
        super(0);
