...
final class RetrofitNoteRemoteRepository$deleteSymptoms$2 extends w implements l<NoteRetrofit1Api, DeleteResponse> {
    final /* synthetic */ String $assoSymptomIds;
    final /* synthetic */ long $noteGroupId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitNoteRemoteRepository$deleteSymptoms$2(long j5, String str) {
        super(1);
        this.$noteGroupId = j5;
    ...
    public final DeleteResponse invoke(NoteRetrofit1Api withApiForAccount) {
        ...
        return withApiForAccount.deleteSymptoms(this.$noteGroupId, this.$assoSymptomIds);
    }
}
