...
final class RetrofitNoteRemoteRepository$deleteComments$2 extends w implements l<NoteRetrofit1Api, DeleteResponse> {
    final /* synthetic */ long $noteGroupId;
    final /* synthetic */ String $textIds;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitNoteRemoteRepository$deleteComments$2(long j5, String str) {
        super(1);
        this.$noteGroupId = j5;
        this.$textIds = str;
    }
    ...
    public final DeleteResponse invoke(NoteRetrofit1Api withApiForAccount) {
        ...
        return withApiForAccount.deleteComments(this.$noteGroupId, this.$textIds);
    }
}
