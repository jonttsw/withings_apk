...
final class RetrofitNoteRemoteRepository$updateNoteGroup$2 extends w implements l<NoteRetrofit1Api, SaveNoteGroupResponse> {
    ...
    public RetrofitNoteRemoteRepository$updateNoteGroup$2(long j5, long j11, boolean z5) {
        super(1);
        this.$noteGroupId = j5;
        this.$date = j11;
        this.$noSymptom = z5;
    ...
    public final SaveNoteGroupResponse invoke(NoteRetrofit1Api withApiForAccount) {
        ...
        return withApiForAccount.updateNoteGroup(this.$noteGroupId, this.$date, this.$noSymptom);
    }
}
