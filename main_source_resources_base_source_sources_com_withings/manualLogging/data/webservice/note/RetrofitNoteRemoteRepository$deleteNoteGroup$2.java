...
final class RetrofitNoteRemoteRepository$deleteNoteGroup$2 extends w implements l<NoteRetrofit1Api, DeleteResponse> {
    final /* synthetic */ long $noteGroupId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitNoteRemoteRepository$deleteNoteGroup$2(long j5) {
        super(1);
        this.$noteGroupId = j5;
    }
    ...
    public final DeleteResponse invoke(NoteRetrofit1Api withApiForAccount) {
        ...
        return withApiForAccount.deleteNoteGroup(this.$noteGroupId);
    }
}
