...
final class RetrofitHealthAttributeRemoteRepository$getUsersHealthAttributes$2 extends w implements l<HealthAttributeRetrofit1Api, GetHealthAttributeResponse> {
    ...
    public RetrofitHealthAttributeRemoteRepository$getUsersHealthAttributes$2(long j5, Long l5, int i11) {
        super(1);
        this.$userId = j5;
        this.$lastUpdate = l5;
        this.$offset = i11;
    ...
    public final GetHealthAttributeResponse invoke(HealthAttributeRetrofit1Api withApiForAccount) {
        ...
        return withApiForAccount.getUsersHealthAttributes(this.$userId, this.$lastUpdate, this.$offset);
    }
}
