...
final class RetrofitHealthAttributeRemoteRepository$getSymptoms$2 extends w implements l<HealthAttributeRetrofit1Api, GetHealthAttributeResponse> {
    final /* synthetic */ Long $lastUpdate;
    final /* synthetic */ int $offset;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitHealthAttributeRemoteRepository$getSymptoms$2(Long l5, int i11) {
        super(1);
        this.$lastUpdate = l5;
        this.$offset = i11;
    }
    ...
    public final GetHealthAttributeResponse invoke(HealthAttributeRetrofit1Api withApiForAccount) {
        ...
        return withApiForAccount.getSymptoms(this.$lastUpdate, this.$offset);
    }
}
