...
final class w0 extends kotlin.jvm.internal.w implements ym0.l<String, nm0.y> {
    ...
    final /* synthetic */ ym0.l<fx.c, nm0.y> f41602a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ List<fx.c> f41603b;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public w0(ym0.l<? super fx.c, nm0.y> lVar, List<fx.c> list) {
        super(1);
        this.f41602a = lVar;
        this.f41603b = list;
    }
    ...
    public final nm0.y invoke(String str) {
        ...
        Iterator<T> it = this.f41603b.iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
        ...
        this.f41602a.invoke(new fx.c(name, j5, null, 4));
