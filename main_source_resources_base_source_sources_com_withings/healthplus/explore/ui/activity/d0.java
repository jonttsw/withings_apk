...
final class d0 extends kotlin.jvm.internal.w implements ym0.p<String, ContentCategory, nm0.y> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ ExploreTabActivity f40306a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d0(ExploreTabActivity exploreTabActivity) {
        super(2);
        this.f40306a = exploreTabActivity;
    }
    ...
    public final nm0.y invoke(String str, ContentCategory contentCategory) {
        ...
        ExploreTabActivity.E3(this.f40306a).j0(contentId, taskType.getWsValue());
