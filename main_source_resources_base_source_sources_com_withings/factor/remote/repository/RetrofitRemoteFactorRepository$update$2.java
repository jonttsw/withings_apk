...
final class RetrofitRemoteFactorRepository$update$2 extends w implements l<FactorRetrofit1Api, y> {
    ...
    public RetrofitRemoteFactorRepository$update$2(long j5, long j11, long j12, Long l5, Integer num) {
        super(1);
        this.$userId = j5;
        this.$factorId = j11;
    ...
    public final void invoke2(FactorRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.update(this.$userId, this.$factorId, this.$startDateInSeconds, this.$endDateInSeconds, this.$numberOfPills);
    }
}
