...
public final class FactorDao_RoomDb_Impl implements FactorDao {
    ...
    public FactorDao_RoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfFactorEntity = new k<FactorEntity>(roomDatabase) { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.1
            {
                FactorDao_RoomDb_Impl.this = this;
            }
            ...
            public void bind(f fVar, FactorEntity factorEntity) {
                ...
                pm.b bVar = FactorDao_RoomDb_Impl.this.__commonRoomConverter;
                Instant start = factorEntity.getStart();
                bVar.getClass();
                fVar.v(5, pm.b.f(start));
                pm.b bVar2 = FactorDao_RoomDb_Impl.this.__commonRoomConverter;
                ...
                pm.b bVar3 = FactorDao_RoomDb_Impl.this.__commonRoomConverter;
                ...
                pm.b bVar4 = FactorDao_RoomDb_Impl.this.__commonRoomConverter;
                Instant created = factorEntity.getCreated();
                bVar4.getClass();
                fVar.v(10, pm.b.f(created));
                pm.b bVar5 = FactorDao_RoomDb_Impl.this.__commonRoomConverter;
                Instant modified = factorEntity.getModified();
                bVar5.getClass();
                fVar.v(11, pm.b.f(modified));
            }
        };
        this.__preparedStmtOfClear = new h0(roomDatabase) { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.2
            {
                FactorDao_RoomDb_Impl.this = this;
            }
        ...
        this.__preparedStmtOfClear_1 = new h0(roomDatabase) { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.3
            {
                FactorDao_RoomDb_Impl.this = this;
            }
    ...
    public Object clear(d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.6
            {
                FactorDao_RoomDb_Impl.this = this;
            }
            ...
            public y call() throws Exception {
                f acquire = FactorDao_RoomDb_Impl.this.__preparedStmtOfClear.acquire();
                try {
                    FactorDao_RoomDb_Impl.this.__db.c();
                    acquire.H();
                    FactorDao_RoomDb_Impl.this.__db.z();
                    y yVar = y.f85009a;
                    FactorDao_RoomDb_Impl.this.__db.h();
                    return yVar;
                } finally {
                    FactorDao_RoomDb_Impl.this.__preparedStmtOfClear.release(acquire);
                }
            }
        }, dVar);
    }
    ...
    public Flow<FactorEntity> getById(long j5) {
        ...
        c11.v(1, j5);
        return g.a(this.__db, false, new String[]{"FACTOR"}, new Callable<FactorEntity>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.11
            {
                FactorDao_RoomDb_Impl.this = this;
            }
            ...
            public FactorEntity call() throws Exception {
                Boolean valueOf;
                Cursor c12 = x8.b.c(FactorDao_RoomDb_Impl.this.__db, c11, false);
                try {
                    ...
                    if (c12.moveToFirst()) {
                        ...
                        FactorDao_RoomDb_Impl.this.__commonRoomConverter.getClass();
    ...
    public Flow<FactorEntity> getByWsId(long j5) {
        ...
        c11.v(1, j5);
        return g.a(this.__db, false, new String[]{"FACTOR"}, new Callable<FactorEntity>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.10
            {
                FactorDao_RoomDb_Impl.this = this;
            }
    ...
    public Object getLastModified(long j5, d<? super Instant> dVar) {
        ...
        return g.b(this.__db, v0.c(c11, 1, j5), new Callable<Instant>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.8
            {
                FactorDao_RoomDb_Impl.this = this;
            }
    ...
    public Flow<List<FactorEntity>> getNotDeleted(long j5) {
        ...
        c11.v(1, j5);
        return g.a(this.__db, false, new String[]{"FACTOR"}, new Callable<List<FactorEntity>>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.9
            {
                FactorDao_RoomDb_Impl.this = this;
            }
    ...
    @Override // com.withings.factor.local.dao.FactorDao
    public Object replaceAll(List<FactorEntity> list, d<? super y> dVar) {
        return b0.a(this.__db, new b(0, this, list), dVar);
    }

    @Override // com.withings.factor.local.dao.FactorDao
    public Object upsert(final FactorEntity factorEntity, d<? super Long> dVar) {
        return g.c(this.__db, new Callable<Long>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.4
            {
                FactorDao_RoomDb_Impl.this = this;
            }
            ...
            public Long call() throws Exception {
                FactorDao_RoomDb_Impl.this.__db.c();
                try {
                    Long valueOf = Long.valueOf(FactorDao_RoomDb_Impl.this.__insertionAdapterOfFactorEntity.insertAndReturnId(factorEntity));
                    FactorDao_RoomDb_Impl.this.__db.z();
                    return valueOf;
                } finally {
                    FactorDao_RoomDb_Impl.this.__db.h();
    ...
    public Object clear(final long j5, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.7
            {
                FactorDao_RoomDb_Impl.this = this;
            }
            ...
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                f acquire = FactorDao_RoomDb_Impl.this.__preparedStmtOfClear_1.acquire();
                acquire.v(1, j5);
                try {
                    FactorDao_RoomDb_Impl.this.__db.c();
                    acquire.H();
                    ...
                    FactorDao_RoomDb_Impl.this.__preparedStmtOfClear_1.release(acquire);
                }
            }
        }, dVar);
    }
    ...
    public Object upsert(final List<FactorEntity> list, d<? super List<Long>> dVar) {
        return g.c(this.__db, new Callable<List<Long>>() { // from class: com.withings.factor.local.dao.FactorDao_RoomDb_Impl.5
            {
                FactorDao_RoomDb_Impl.this = this;
            }
            ...
            public List<Long> call() throws Exception {
                FactorDao_RoomDb_Impl.this.__db.c();
                try {
                    List<Long> insertAndReturnIdsList = FactorDao_RoomDb_Impl.this.__insertionAdapterOfFactorEntity.insertAndReturnIdsList(list);
                    FactorDao_RoomDb_Impl.this.__db.z();
