...
final class s0 extends kotlin.jvm.internal.w implements ym0.p<androidx.compose.runtime.a, Integer, nm0.y> {
    ...
    final /* synthetic */ k1.r0<DateTime> f46130a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ ym0.a<nm0.y> f46131b;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s0(k1.r0<DateTime> r0Var, ym0.a<nm0.y> aVar) {
        super(2);
        this.f46130a = r0Var;
        this.f46131b = aVar;
    }
    ...
    public final nm0.y invoke(androidx.compose.runtime.a aVar, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && aVar2.h()) {
            ...
            if (this.f46130a.getValue() != null) {
                z5 = true;
            } else {
                z5 = false;
            }
            com.withings.common.compose.component.l.a(null, u11, null, z5, colorStyle, null, false, this.f46131b, aVar2, 24576, 101);
        }
