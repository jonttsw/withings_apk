...
final class a1 extends kotlin.jvm.internal.w implements ym0.p<androidx.compose.runtime.a, Integer, nm0.y> {
    ...
    final /* synthetic */ ym0.a<nm0.y> f45843a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public a1(ym0.a<nm0.y> aVar) {
        super(2);
        this.f45843a = aVar;
    }
    ...
    public final nm0.y invoke(androidx.compose.runtime.a aVar, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && aVar2.h()) {
            ...
            com.withings.common.compose.component.l.c(null, ay.b.u(C1987R.string._PREVIOUS_, aVar2), null, false, ColorStyle.f33322a, null, false, this.f45843a, aVar2, 24576, 109);
        }
