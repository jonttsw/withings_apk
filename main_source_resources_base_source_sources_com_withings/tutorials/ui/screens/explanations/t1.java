...
final class t1 extends kotlin.jvm.internal.w implements ym0.r<l0.c, androidx.navigation.d, androidx.compose.runtime.a, Integer, nm0.y> {
    ...
    final /* synthetic */ ym0.a<nm0.y> f45255a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ r8.n f45256b;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public t1(r8.n nVar, ym0.a aVar) {
        super(4);
        this.f45255a = aVar;
        this.f45256b = nVar;
    }
    ...
    public final nm0.y invoke(l0.c cVar, androidx.navigation.d dVar, androidx.compose.runtime.a aVar, Integer num) {
        ...
        s1 s1Var = new s1(this.f45256b);
        c2.c(this.f45255a, s1Var, aVar, 0);
