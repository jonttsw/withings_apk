...
public final class TargetDAO_RoomDb_Impl implements TargetDAO {
    ...
    public TargetDAO_RoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfTarget = new k<Target>(roomDatabase) { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.1
            ...
            public void bind(f fVar, Target target) {
                ...
                b bVar = TargetDAO_RoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar2 = TargetDAO_RoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar3 = TargetDAO_RoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar4 = TargetDAO_RoomDb_Impl.this.__commonRoomConverter;
        ...
        this.__updateAdapterOfTarget = new j<Target>(roomDatabase) { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.2
        ...
        this.__preparedStmtOfClear = new h0(roomDatabase) { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.3
            @Override // androidx.room.h0
    ...
    public Flow<List<Target>> getActiveStepTargetsForAllUser() {
        ...
        return g.a(this.__db, false, new String[]{"Target"}, new Callable<List<Target>>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.7
            ...
            public List<Target> call() throws Exception {
                ...
                int i13;
                boolean z5;
                Cursor c12 = x8.b.c(TargetDAO_RoomDb_Impl.this.__db, c11, false);
                try {
                    int b10 = a.b(c12, "id");
                    ...
                    while (c12.moveToNext()) {
                        ...
                        TargetDAO_RoomDb_Impl.this.__commonRoomConverter.getClass();
    ...
    public Flow<List<Target>> getAllActivatedTargetsForUserFlow(long j5) {
        ...
        c11.v(1, j5);
        return g.a(this.__db, false, new String[]{"Target"}, new Callable<List<Target>>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.8
            protected void finalize() {
                c11.release();
            }
    ...
    public Flow<Target> getLastActiveTargetByTypeForUserFlow(long j5, int i11) {
        ...
        c11.v(1, j5);
        c11.v(2, i11);
        return g.a(this.__db, false, new String[]{"Target"}, new Callable<Target>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.10
            protected void finalize() {
                c11.release();
            }
    ...
    public Flow<Target> getLastActiveTargetForUserFlow(long j5, int i11, int i12) {
        ...
        c11.v(2, i11);
        c11.v(3, i12);
        return g.a(this.__db, false, new String[]{"Target"}, new Callable<Target>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.9
            protected void finalize() {
                c11.release();
            }
    ...
    public Flow<Target> getLastTargetForUserFlow(long j5, int i11, int i12) {
        ...
        c11.v(2, i11);
        c11.v(3, i12);
        return g.a(this.__db, false, new String[]{"Target"}, new Callable<Target>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.11
            protected void finalize() {
                c11.release();
            }
    ...
    public Flow<Target> getTargetAtTimeFlow(long j5, int i11, int i12, DateTime dateTime) {
        ...
        return g.a(this.__db, false, new String[]{"Target"}, new Callable<Target>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.12
            protected void finalize() {
                c11.release();
            }
    ...
    public Object insert(final Target target, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.4
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                TargetDAO_RoomDb_Impl.this.__db.c();
                try {
                    TargetDAO_RoomDb_Impl.this.__insertionAdapterOfTarget.insert((k) target);
                    TargetDAO_RoomDb_Impl.this.__db.z();
                    return y.f85009a;
                } finally {
                    TargetDAO_RoomDb_Impl.this.__db.h();
                }
            }
        }, dVar);
    }
    ...
    public Object update(final Target target, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.6
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                TargetDAO_RoomDb_Impl.this.__db.c();
                try {
                    TargetDAO_RoomDb_Impl.this.__updateAdapterOfTarget.handle(target);
                    TargetDAO_RoomDb_Impl.this.__db.z();
                    return y.f85009a;
                } finally {
                    TargetDAO_RoomDb_Impl.this.__db.h();
    ...
    public Object insert(final List<Target> list, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.target.data.TargetDAO_RoomDb_Impl.5
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                TargetDAO_RoomDb_Impl.this.__db.c();
                try {
                    TargetDAO_RoomDb_Impl.this.__insertionAdapterOfTarget.insert((Iterable) list);
                    TargetDAO_RoomDb_Impl.this.__db.z();
                    return y.f85009a;
                } finally {
                    TargetDAO_RoomDb_Impl.this.__db.h();
