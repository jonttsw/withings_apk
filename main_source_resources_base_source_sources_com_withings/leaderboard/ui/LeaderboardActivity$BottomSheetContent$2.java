...
public final class LeaderboardActivity$BottomSheetContent$2 extends w implements p<a, Integer, y> {
    ...
    public LeaderboardActivity$BottomSheetContent$2(LeaderboardActivity leaderboardActivity, c5 c5Var, SharePublicKey sharePublicKey, int i11) {
        super(2);
    ...
    public final void invoke(a aVar, int i11) {
        this.$tmp0_rcvr.BottomSheetContent(this.$modalBottomSheetState, this.$sharedPublicKey, aVar, o.g(this.$$changed | 1));
    }
}
