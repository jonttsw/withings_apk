...
import com.withings.leaderboard.ui.MyFriendCodeActivity;
...
public final class LeaderboardActivity$BottomSheetContent$1$2 extends w implements a<y> {
    ...
    @e(c = "com.withings.leaderboard.ui.LeaderboardActivity$BottomSheetContent$1$2$1", f = "LeaderboardActivity.kt", l = {ConstantsWs.WS_STATUS_NOPWDUPDATECODE}, m = "invokeSuspend")
    /* renamed from: com.withings.leaderboard.ui.LeaderboardActivity$BottomSheetContent$1$2$1  reason: invalid class name */
    /* loaded from: classes3.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardActivity$BottomSheetContent$1$2(CoroutineScope coroutineScope, SharePublicKey sharePublicKey, c5 c5Var, LeaderboardActivity leaderboardActivity) {
        super(0);
    ...
    public final void invoke2() {
        ...
        SharePublicKey sharePublicKey = this.$sharedPublicKey;
        if (sharePublicKey != null) {
            LeaderboardActivity leaderboardActivity = this.this$0;
            String l5 = m70.i.b().e().l();
            MyFriendCodeActivity.Companion companion = MyFriendCodeActivity.Companion;
            u.g(l5);
            leaderboardActivity.startActivityForResult(companion.createIntent(leaderboardActivity, l5, sharePublicKey.getHash()), 4321);
        }
    }
}
