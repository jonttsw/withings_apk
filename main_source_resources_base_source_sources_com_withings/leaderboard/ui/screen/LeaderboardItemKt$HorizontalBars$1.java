...
public final class LeaderboardItemKt$HorizontalBars$1 extends w implements p<a, Integer, y> {
    final /* synthetic */ int $$changed;
    final /* synthetic */ List<LeaderBoardUiEntry> $leaderboardEntries;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardItemKt$HorizontalBars$1(List<LeaderBoardUiEntry> list, int i11) {
        super(2);
