...
public final class LeaderboardActivity$BottomSheetContent$1$3 extends w implements a<y> {
    ...
    @e(c = "com.withings.leaderboard.ui.LeaderboardActivity$BottomSheetContent$1$3$1", f = "LeaderboardActivity.kt", l = {ConstantsWs.WS_STATUS_WRONGAPPLICATIONCTX}, m = "invokeSuspend")
    /* renamed from: com.withings.leaderboard.ui.LeaderboardActivity$BottomSheetContent$1$3$1  reason: invalid class name */
    /* loaded from: classes3.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardActivity$BottomSheetContent$1$3(CoroutineScope coroutineScope, SharePublicKey sharePublicKey, c5 c5Var, LeaderboardActivity leaderboardActivity) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if (sharePublicKey != null) {
            ...
            String string = leaderboardActivity.getString(C1987R.string._INVITATION_BROADCAST__s_, sharePublicKey.getShorturl());
            u.i(string, "getString(...)");
            leaderboardActivity.inviteToLeaderboard(string);
        }
    }
}
