...
final class RetrofitLeaderboardRemoteRepository$join$2 extends w implements l<LeaderboardRetrofit1Api, y> {
    final /* synthetic */ String $hash;
    final /* synthetic */ long $userId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetrofitLeaderboardRemoteRepository$join$2(long j5, String str) {
        super(1);
        this.$userId = j5;
        this.$hash = str;
    }
    ...
    public final void invoke2(LeaderboardRetrofit1Api withApiForAccount) {
        ...
        withApiForAccount.join(this.$userId, this.$hash);
    }
}
