...
public final class LeaderboardDAO_RoomDb_Impl implements LeaderboardDAO {
    ...
    public LeaderboardDAO_RoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfLeaderboardEntry = new k<LeaderboardEntry>(roomDatabase) { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.1
            ...
            public void bind(f fVar, LeaderboardEntry leaderboardEntry) {
                ...
                b bVar = LeaderboardDAO_RoomDb_Impl.this.__commonRoomConverter;
        ...
        this.__preparedStmtOfDelete = new h0(roomDatabase) { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.2
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM leaderboard WHERE date = ?";
            }
        };
        this.__preparedStmtOfDelete_1 = new h0(roomDatabase) { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.3
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM leaderboard WHERE userid = ?";
            }
        };
        this.__preparedStmtOfClear = new h0(roomDatabase) { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.4
            @Override // androidx.room.h0
            public String createQuery() {
    ...
    public Object getLeaderboard(String str, d<? super List<LeaderboardEntry>> dVar) {
        ...
        c11.s(1, str);
        return g.b(this.__db, new CancellationSignal(), new Callable<List<LeaderboardEntry>>() { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.7
            @Override // java.util.concurrent.Callable
            public List<LeaderboardEntry> call() throws Exception {
                Cursor c12 = x8.b.c(LeaderboardDAO_RoomDb_Impl.this.__db, c11, false);
                try {
                    int b10 = a.b(c12, "id");
                    ...
                    while (c12.moveToNext()) {
                        ...
                        LeaderboardDAO_RoomDb_Impl.this.__commonRoomConverter.getClass();
                        DateTime a11 = b.a(l5);
                        if (a11 != null) {
    ...
    public Flow<List<LeaderboardEntry>> getLeaderboardFlow(String str) {
        final d0 c11 = d0.c(1, "SELECT * FROM leaderboard WHERE date = ? ORDER BY score DESC");
        c11.s(1, str);
        return g.a(this.__db, false, new String[]{"leaderboard"}, new Callable<List<LeaderboardEntry>>() { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.8
    ...
    public Object getMostRecentEntry(long j5, d<? super LeaderboardEntry> dVar) {
        ...
        return g.b(this.__db, v0.c(c11, 1, j5), new Callable<LeaderboardEntry>() { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.6
    ...
    public Object delete(final long j5, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl.5
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                f acquire = LeaderboardDAO_RoomDb_Impl.this.__preparedStmtOfDelete_1.acquire();
                acquire.v(1, j5);
                try {
                    LeaderboardDAO_RoomDb_Impl.this.__db.c();
                    acquire.H();
                    LeaderboardDAO_RoomDb_Impl.this.__db.z();
                    y yVar = y.f85009a;
                    LeaderboardDAO_RoomDb_Impl.this.__db.h();
                    return yVar;
                } finally {
                    LeaderboardDAO_RoomDb_Impl.this.__preparedStmtOfDelete_1.release(acquire);
                }
            }
        }, dVar);
    }
