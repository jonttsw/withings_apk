...
final class GpsLocationSerializer$initTypeValuesSetter$9 extends w implements l<GpsLocation, Double> {
    public static final GpsLocationSerializer$initTypeValuesSetter$9 INSTANCE = new GpsLocationSerializer$initTypeValuesSetter$9();

    GpsLocationSerializer$initTypeValuesSetter$9() {
        super(1);
    }
    ...
    public final Double invoke(GpsLocation location) {
        ...
        reduceDecimal = GpsLocationSerializerKt.reduceDecimal(location.getAccuracy().getSpeed());
