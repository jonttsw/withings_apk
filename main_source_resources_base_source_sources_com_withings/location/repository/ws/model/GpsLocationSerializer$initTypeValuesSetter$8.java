...
final class GpsLocationSerializer$initTypeValuesSetter$8 extends w implements l<GpsLocation, Double> {
    public static final GpsLocationSerializer$initTypeValuesSetter$8 INSTANCE = new GpsLocationSerializer$initTypeValuesSetter$8();

    GpsLocationSerializer$initTypeValuesSetter$8() {
        super(1);
    }
    ...
    public final Double invoke(GpsLocation location) {
        ...
        reduceDecimal = GpsLocationSerializerKt.reduceDecimal(location.getAccuracy().getBearing());
