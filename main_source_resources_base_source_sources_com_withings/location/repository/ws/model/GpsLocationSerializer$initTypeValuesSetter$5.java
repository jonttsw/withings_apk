...
final class GpsLocationSerializer$initTypeValuesSetter$5 extends w implements l<GpsLocation, Double> {
    public static final GpsLocationSerializer$initTypeValuesSetter$5 INSTANCE = new GpsLocationSerializer$initTypeValuesSetter$5();

    GpsLocationSerializer$initTypeValuesSetter$5() {
        super(1);
    }
    ...
    public final Double invoke(GpsLocation location) {
        ...
        reduceGpsDecimal = GpsLocationSerializerKt.reduceGpsDecimal(location.getPosition().getLatitude());
