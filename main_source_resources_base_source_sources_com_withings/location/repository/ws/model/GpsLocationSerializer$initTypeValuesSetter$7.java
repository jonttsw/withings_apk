...
final class GpsLocationSerializer$initTypeValuesSetter$7 extends w implements l<GpsLocation, Double> {
    public static final GpsLocationSerializer$initTypeValuesSetter$7 INSTANCE = new GpsLocationSerializer$initTypeValuesSetter$7();

    GpsLocationSerializer$initTypeValuesSetter$7() {
        super(1);
    }
    ...
    public final Double invoke(GpsLocation location) {
        ...
        reduceDecimal = GpsLocationSerializerKt.reduceDecimal(location.getBearing());
