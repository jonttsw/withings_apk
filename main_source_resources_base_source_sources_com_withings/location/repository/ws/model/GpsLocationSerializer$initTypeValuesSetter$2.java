...
final class GpsLocationSerializer$initTypeValuesSetter$2 extends w implements l<GpsLocation, Double> {
    public static final GpsLocationSerializer$initTypeValuesSetter$2 INSTANCE = new GpsLocationSerializer$initTypeValuesSetter$2();

    GpsLocationSerializer$initTypeValuesSetter$2() {
        super(1);
    }
    ...
    public final Double invoke(GpsLocation location) {
        ...
        reduceDecimal = GpsLocationSerializerKt.reduceDecimal(location.getAccuracy().getHorizontal());
