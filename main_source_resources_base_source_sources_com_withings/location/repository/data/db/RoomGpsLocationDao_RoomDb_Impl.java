...
public final class RoomGpsLocationDao_RoomDb_Impl implements RoomGpsLocationDao {
    ...
    public RoomGpsLocationDao_RoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfGpsLocationEntity = new k<GpsLocationEntity>(roomDatabase) { // from class: com.withings.location.repository.data.db.RoomGpsLocationDao_RoomDb_Impl.1
            ...
            public void bind(f fVar, GpsLocationEntity gpsLocationEntity) {
                ...
                b bVar = RoomGpsLocationDao_RoomDb_Impl.this.__commonRoomConverter;
        ...
        this.__preparedStmtOfDeleteById = new h0(roomDatabase) { // from class: com.withings.location.repository.data.db.RoomGpsLocationDao_RoomDb_Impl.2
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM workoutLocation WHERE id = ?";
            }
        };
        this.__preparedStmtOfDeleteAll = new h0(roomDatabase) { // from class: com.withings.location.repository.data.db.RoomGpsLocationDao_RoomDb_Impl.3
            @Override // androidx.room.h0
            public String createQuery() {
    ...
    public Flow<List<GpsLocationEntity>> getForUserAfter(long j5, long j11, float f11) {
        ...
        c11.v(2, j11);
        c11.f2(f11, 3);
        return g.a(this.__db, false, new String[]{"workoutLocation"}, new Callable<List<GpsLocationEntity>>() { // from class: com.withings.location.repository.data.db.RoomGpsLocationDao_RoomDb_Impl.5
            ...
            public List<GpsLocationEntity> call() throws Exception {
                Cursor c12 = x8.b.c(RoomGpsLocationDao_RoomDb_Impl.this.__db, c11, false);
                try {
                    int b10 = a.b(c12, "id");
                    ...
                    while (c12.moveToNext()) {
                        ...
                        RoomGpsLocationDao_RoomDb_Impl.this.__commonRoomConverter.getClass();
                        DateTime a11 = b.a(l5);
                        if (a11 != null) {
                            int i12 = i11;
                            int i13 = b24;
    ...
    public Flow<List<GpsLocationEntity>> getForUserBefore(long j5, long j11, float f11) {
        ...
        c11.v(2, j11);
        c11.f2(f11, 3);
        return g.a(this.__db, false, new String[]{"workoutLocation"}, new Callable<List<GpsLocationEntity>>() { // from class: com.withings.location.repository.data.db.RoomGpsLocationDao_RoomDb_Impl.6
            protected void finalize() {
                c11.release();
            }
    ...
    public Flow<List<GpsLocationEntity>> getForUserBetween(long j5, long j11, long j12, float f11) {
        ...
        c11.v(3, j12);
        c11.f2(f11, 4);
        return g.a(this.__db, false, new String[]{"workoutLocation"}, new Callable<List<GpsLocationEntity>>() { // from class: com.withings.location.repository.data.db.RoomGpsLocationDao_RoomDb_Impl.4
            protected void finalize() {
                c11.release();
            }
