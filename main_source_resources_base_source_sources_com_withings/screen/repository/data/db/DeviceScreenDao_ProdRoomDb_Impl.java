...
public final class DeviceScreenDao_ProdRoomDb_Impl implements DeviceScreenDao {
    ...
    public DeviceScreenDao_ProdRoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfDeviceScreenEntity = new k<DeviceScreenEntity>(roomDatabase) { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.1
            ...
            public void bind(f fVar, DeviceScreenEntity deviceScreenEntity) {
                ...
                String deviceScreenImageToString = DeviceScreenDao_ProdRoomDb_Impl.this.__deviceScreenConverters.deviceScreenImageToString(deviceScreenEntity.getImages());
                ...
                b bVar = DeviceScreenDao_ProdRoomDb_Impl.this.__commonRoomConverter;
                ...
                String listOfListOfIntToString = DeviceScreenDao_ProdRoomDb_Impl.this.__deviceScreenConverters.listOfListOfIntToString(deviceScreenEntity.getRequiredFeatureIds());
        ...
        this.__preparedStmtOfClearFor = new h0(roomDatabase) { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.2
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM devicescreen WHERE userId = ? AND deviceId = ?";
            }
        };
        this.__preparedStmtOfClear = new h0(roomDatabase) { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.3
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM devicescreen WHERE deviceId = ?";
            }
        };
        this.__preparedStmtOfClear_1 = new h0(roomDatabase) { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.4
            @Override // androidx.room.h0
            public String createQuery() {
    ...
    public Object clear(final long j5, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.7
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                f acquire = DeviceScreenDao_ProdRoomDb_Impl.this.__preparedStmtOfClear.acquire();
                acquire.v(1, j5);
                try {
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.c();
                    acquire.H();
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.z();
                    y yVar = y.f85009a;
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.h();
                    return yVar;
                } finally {
                    DeviceScreenDao_ProdRoomDb_Impl.this.__preparedStmtOfClear.release(acquire);
                }
            }
        }, dVar);
    }
    ...
    public Object clearFor(final long j5, final long j11, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.6
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                f acquire = DeviceScreenDao_ProdRoomDb_Impl.this.__preparedStmtOfClearFor.acquire();
                acquire.v(1, j5);
                acquire.v(2, j11);
                try {
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.c();
                    ...
                    DeviceScreenDao_ProdRoomDb_Impl.this.__preparedStmtOfClearFor.release(acquire);
                }
            }
        }, dVar);
    }
    ...
    public Flow<List<DeviceScreenEntity>> get(long j5, long j11) {
        ...
        c11.v(1, j5);
        c11.v(2, j11);
        return g.a(this.__db, false, new String[]{"devicescreen"}, new Callable<List<DeviceScreenEntity>>() { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.9
            ...
            */
            public java.util.List<com.withings.screen.repository.data.model.DeviceScreenEntity> call() throws java.lang.Exception {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.AnonymousClass9.call():java.util.List");
            }
        });
    }
    ...
    public Object insertOrUpdate(final List<DeviceScreenEntity> list, d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.5
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                DeviceScreenDao_ProdRoomDb_Impl.this.__db.c();
                try {
                    DeviceScreenDao_ProdRoomDb_Impl.this.__insertionAdapterOfDeviceScreenEntity.insert((Iterable) list);
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.z();
                    return y.f85009a;
                } finally {
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.h();
    ...
    public Object clear(d<? super y> dVar) {
        return g.c(this.__db, new Callable<y>() { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.8
            @Override // java.util.concurrent.Callable
            public y call() throws Exception {
                f acquire = DeviceScreenDao_ProdRoomDb_Impl.this.__preparedStmtOfClear_1.acquire();
                try {
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.c();
                    acquire.H();
                    DeviceScreenDao_ProdRoomDb_Impl.this.__db.z();
                    ...
                    DeviceScreenDao_ProdRoomDb_Impl.this.__preparedStmtOfClear_1.release(acquire);
                }
            }
        }, dVar);
    }
    ...
    public Flow<List<DeviceScreenEntity>> get(long j5) {
        ...
        c11.v(1, j5);
        return g.a(this.__db, false, new String[]{"devicescreen"}, new Callable<List<DeviceScreenEntity>>() { // from class: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.10
            protected void finalize() {
                c11.release();
            }
            ...
            */
            public java.util.List<com.withings.screen.repository.data.model.DeviceScreenEntity> call() throws java.lang.Exception {
                /*
                    ...
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: com.withings.screen.repository.data.db.DeviceScreenDao_ProdRoomDb_Impl.AnonymousClass10.call():java.util.List");
            }
        });
    }
}
