...
@e(c = "com.withings.screen.repository.RoomDeviceScreensRepository$get$2", f = "RoomDeviceScreensRepository.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class RoomDeviceScreensRepository$get$2 extends i implements r<List<? extends DeviceScreensGroupEntity>, List<? extends DeviceScreenEntity>, List<? extends DeviceScreenContentEntity>, d<? super List<? extends DeviceScreensGroup>>, Object> {
    ...
    public RoomDeviceScreensRepository$get$2(RoomDeviceScreensRepository roomDeviceScreensRepository, d<? super RoomDeviceScreensRepository$get$2> dVar) {
        super(4, dVar);
    ...
    public final Object invoke2(List<DeviceScreensGroupEntity> list, List<DeviceScreenEntity> list2, List<DeviceScreenContentEntity> list3, d<? super List<DeviceScreensGroup>> dVar) {
        RoomDeviceScreensRepository$get$2 roomDeviceScreensRepository$get$2 = new RoomDeviceScreensRepository$get$2(this.this$0, dVar);
        roomDeviceScreensRepository$get$2.L$0 = list;
        roomDeviceScreensRepository$get$2.L$1 = list2;
        roomDeviceScreensRepository$get$2.L$2 = list3;
        return roomDeviceScreensRepository$get$2.invokeSuspend(y.f85009a);
    }
}
