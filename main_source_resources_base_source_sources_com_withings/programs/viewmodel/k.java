...
public final class k extends w implements ym0.l<ProgramDomain, ProgramPreviewUi.Discover> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ AchieveViewModel f43835a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(AchieveViewModel achieveViewModel) {
        super(1);
        this.f43835a = achieveViewModel;
    }
