...
import yi.d;
import ym0.q;
/* compiled from: Hwa10UpgradeSetup.kt */
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u00032\u00020\u0004B\u0007¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lcom/withings/wiscale2/device/hwa10/ui/Hwa10UpgradeSetup;", "Lcom/withings/devicesetup/Setup;", "Lcom/withings/devicesetup/Setup$WithUpgrade;", "Lcom/withings/devicesetup/Setup$WithBatteryCheck;", "Lcom/withings/devicesetup/Setup$l;", "<init>", "()V", "HealthMate_prodRelease"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes5.dex */
public final class Hwa10UpgradeSetup implements Setup, Setup.WithUpgrade, Setup.WithBatteryCheck, Setup.l {
    public static final Parcelable.Creator<Hwa10UpgradeSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private DevicePictures f54563a;

    /* renamed from: b  reason: collision with root package name */
    private long[] f54564b;

    /* renamed from: c  reason: collision with root package name */
    private final g f54565c = h.b(b.f54566a);

    /* compiled from: Hwa10UpgradeSetup.kt */
    /* loaded from: classes5.dex */
    public static final class a implements Parcelable.Creator<Hwa10UpgradeSetup> {
        @Override // android.os.Parcelable.Creator
        public final Hwa10UpgradeSetup createFromParcel(Parcel parcel) {
            u.j(parcel, "parcel");
            parcel.readInt();
            return new Hwa10UpgradeSetup();
        }

        @Override // android.os.Parcelable.Creator
        public final Hwa10UpgradeSetup[] newArray(int i11) {
            return new Hwa10UpgradeSetup[i11];
        }
    }
    ...
    static final class b extends w implements ym0.a<e> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final b f54566a = new w(0);
    ...
    public static final e a(Hwa10UpgradeSetup hwa10UpgradeSetup) {
        return (e) hwa10UpgradeSetup.f54565c.getValue();
    }

    private final Object g() {
        String url;
        DevicePictures devicePictures = this.f54563a;
    ...
    public final int G0() {
        return C1987R.string.hwa09_upgrade_message_batteryLow;
    }
    ...
    public final WppDeviceConversation M2(SetupConversation setupConversation) {
        ...
        return new WppDeviceConversation() { // from class: com.withings.wiscale2.device.hwa10.ui.Hwa10UpgradeSetup$getPreUpgradeConversation$1
            ...
            static final class a extends w implements q<Integer, long[], List<? extends ImageMetadata>, y> {
                ...
                /* renamed from: a  reason: collision with root package name */
                final /* synthetic */ Hwa10UpgradeSetup f54570a;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                a(Hwa10UpgradeSetup hwa10UpgradeSetup) {
                    super(3);
                    this.f54570a = hwa10UpgradeSetup;
                }
            ...
            public final void D() {
                c cVar;
                Hwa10UpgradeSetup hwa10UpgradeSetup = Hwa10UpgradeSetup.this;
                e a11 = Hwa10UpgradeSetup.a(hwa10UpgradeSetup);
                ...
                if (cVar != null) {
                    ...
                    E(new WorkoutScreenGetConversation(new a(hwa10UpgradeSetup)));
                    return;
                }
    ...
    @Override // com.withings.devicesetup.Setup
    public final int S1() {
        return C1987R.string.hwa09Setup_detectingMessage;
    }
    ...
    public final WppDeviceConversation V1(SetupConversation setupConversation) {
        u.j(setupConversation, "setupConversation");
        return new WppDeviceConversation() { // from class: com.withings.wiscale2.device.hwa10.ui.Hwa10UpgradeSetup$getInitializingConversation$1
            @Override // com.withings.comm.remote.conversation.WppDeviceConversation
            public final void D() {
                Hwa10UpgradeSetup hwa10UpgradeSetup = Hwa10UpgradeSetup.this;
                Device f11 = Hwa10UpgradeSetup.a(hwa10UpgradeSetup).f(x().g());
                hwa10UpgradeSetup.f54563a = f11.getPictures();
                f11.getColor();
            }
        };
    }
    ...
    public final WppDeviceConversation d2(SetupConversation setupConversation) {
        u.j(setupConversation, "setupConversation");
        return new WppDeviceConversation() { // from class: com.withings.wiscale2.device.hwa10.ui.Hwa10UpgradeSetup$getPostUpgradeConversation$1
            @Override // com.withings.comm.remote.conversation.WppDeviceConversation
            public final void D() {
                long[] jArr;
                boolean z5;
                jArr = Hwa10UpgradeSetup.this.f54564b;
                if (jArr != null) {
                    if (jArr.length == 0) {
                        z5 = true;
                    } else {
    ...
    @Override // com.withings.devicesetup.Setup
    public final int r2() {
        return C1987R.string.hwa10Setup_detectedMessage_empty;
    }
    ...
    @Override // com.withings.devicesetup.Setup.WithBatteryCheck
    public final int v2() {
        return C1987R.string.hwa09_upgrade_title_batteryLow;
    }
    ...
    @Override // com.withings.devicesetup.Setup
    public final int z2() {
        return C1987R.string.hwa10Setup_firmwareUpgradeSuccessTitle;
    }
}
