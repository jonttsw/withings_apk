...
public final class x extends kotlin.jvm.internal.w implements ym0.p<Explanation, View, nm0.y> {
    ...
    final /* synthetic */ Wam03PostInstallActivity f55011a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(Wam03PostInstallActivity wam03PostInstallActivity) {
        super(2);
        this.f55011a = wam03PostInstallActivity;
    }
