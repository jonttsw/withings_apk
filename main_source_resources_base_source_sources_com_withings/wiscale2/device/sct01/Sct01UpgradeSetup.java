...
import nm0.h;
import yi.d;
/* compiled from: Sct01UpgradeSetup.kt */
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u00012\u00020\u0002B\u0007¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, d2 = {"Lcom/withings/wiscale2/device/sct01/Sct01UpgradeSetup;", "Lcom/withings/devicesetup/Setup;", "Lcom/withings/devicesetup/Setup$WithUpgrade;", "<init>", "()V", "HealthMate_prodRelease"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes5.dex */
public final class Sct01UpgradeSetup implements Setup, Setup.WithUpgrade {
    public static final Parcelable.Creator<Sct01UpgradeSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private final g f54776a = h.b(c.f54779a);

    /* renamed from: b  reason: collision with root package name */
    private final g f54777b = h.b(b.f54778a);

    /* compiled from: Sct01UpgradeSetup.kt */
    /* loaded from: classes5.dex */
    public static final class a implements Parcelable.Creator<Sct01UpgradeSetup> {
        @Override // android.os.Parcelable.Creator
        public final Sct01UpgradeSetup createFromParcel(Parcel parcel) {
            u.j(parcel, "parcel");
            parcel.readInt();
        ...
        @Override // android.os.Parcelable.Creator
        public final Sct01UpgradeSetup[] newArray(int i11) {
            return new Sct01UpgradeSetup[i11];
        }
    }
    ...
    static final class b extends w implements ym0.a<de0.a> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final b f54778a = new w(0);
    ...
    static final class c extends w implements ym0.a<q> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final c f54779a = new w(0);
    ...
    private final q a() {
        return (q) this.f54776a.getValue();
    }
    ...
    public final Object d0() {
        return Integer.valueOf(((de0.a) this.f54777b.getValue()).a());
    }

    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final WppDeviceConversation d2(SetupConversation setupConversation) {
        return new WppDeviceConversation() { // from class: com.withings.wiscale2.device.sct01.Sct01UpgradeSetup$getPostUpgradeConversation$1
