...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/withings/wiscale2/device/hwa08/BondAndSyncConversation;", "Lcom/withings/comm/remote/conversation/WppDeviceConversation;", "HealthMate_prodRelease"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes5.dex */
final class BondAndSyncConversation extends WppDeviceConversation {

    /* renamed from: f  reason: collision with root package name */
    private final t f54369f;

    /* renamed from: g  reason: collision with root package name */
    private final w f54370g;
    ...
    public BondAndSyncConversation(t tVar, w wppDeviceManager, a backgroundManager) {
        ...
        this.f54369f = tVar;
        this.f54370g = wppDeviceManager;
        this.f54371h = backgroundManager;
    }
    ...
    public final void D() throws IOException, ConversationException, WaitForInput.CancelException, InterruptedException {
        ...
        if (((o) j5).d() != 12 && this.f54371h.e() && tVar.o(x().i().softVersion)) {
            E(new WppDeviceConversation() { // from class: com.withings.wiscale2.device.hwa08.BondAndSyncConversation$run$1
                @Override // com.withings.comm.remote.conversation.WppDeviceConversation
                public final void D() {
                    try {
                        b j11 = x().j();
        ...
        this.f54370g.O(x(), j02, j02.getClass());
    }
}
