...
public final class d extends kotlin.jvm.internal.w implements ym0.p<Explanation, View, nm0.y> {
    ...
    final /* synthetic */ Hwa08PostInstallActivity f54458a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(Hwa08PostInstallActivity hwa08PostInstallActivity) {
        super(2);
        this.f54458a = hwa08PostInstallActivity;
    }
    ...
    public final nm0.y invoke(Explanation explanation, View view) {
        ...
        Hwa08PostInstallActivity.G3(this.f54458a, 0);
