...
public class Wam01InstallSetup implements Setup, Setup.WithOverview, Setup.g, Setup.e, Setup.WithUpgrade, SetupWithUser, Setup.k, Setup.l {
    public static final Parcelable.Creator<Wam01InstallSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private User f54825a;

    /* loaded from: classes5.dex */
    final class a implements b.a {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ SetupActivity f54826a;

        a(SetupActivity setupActivity) {
            this.f54826a = setupActivity;
        }
    ...
    /* loaded from: classes5.dex */
    final class b implements Parcelable.Creator<Wam01InstallSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wam01InstallSetup createFromParcel(Parcel parcel) {
            return new Wam01InstallSetup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public final Wam01InstallSetup[] newArray(int i11) {
            return new Wam01InstallSetup[i11];
        }
    }

    public Wam01InstallSetup() {
    }
    ...
    public final g J0(SetupActivity setupActivity) {
        return new com.withings.wiscale2.device.wam.b(setupActivity);
    }
    ...
    public final Intent M1(Context context) {
        ...
        String string2 = context.getString(C1987R.string._PULSE_URL_);
    ...
    @Override // com.withings.devicesetup.Setup
    public final int S1() {
        return l.a(C1987R.string._WAM01_CONNECTION_MESSAGE_CONNECTING_);
    }
    ...
    public final int b() {
        return p.f67672b.a().d(51).I(null);
    }

    @Override // com.withings.devicesetup.Setup.g
    public final void c(SetupActivity setupActivity) {
        he0.b bVar = new he0.b();
        bVar.t1(new a(setupActivity));
        setupActivity.h4(bVar, 400);
    }
    ...
    @Override // com.withings.devicesetup.Setup
    public final int e2() {
        return C1987R.string._WAM01_CONNECTION_TITLE_CONNECTING_;
    }

    @Override // com.withings.devicesetup.Setup.l
    public final int f() {
        return C1987R.string._WAM01_CONNECTION_HELPER_SEARCHING_;
    }
    ...
    public final void j(SetupConversation setupConversation) {
        com.withings.device.setup.ui.b.b(this, setupConversation, 51, 0L);
    }
    ...
    public final WppDeviceConversation q(SetupConversation setupConversation) {
        return new Wam01SetUserInfoConversation(e.c().f(setupConversation.v()), this.f54825a);
    }

    @Override // com.withings.devicesetup.Setup
    public final void r0(SetupActivity setupActivity) {
        uc0.e.e(setupActivity);
        uc0.e.f(setupActivity, this.f54825a);
    }
    ...
    public final Intent s(Context context) {
        String string = context.getString(C1987R.string._WAM01_CONNECTION_HELPER_LINK_SEARCHING_);
        return HMWebActivity.f35395c.c(context, context.getString(C1987R.string._HELP_CENTER_), string);
    }

    @Override // com.withings.device.setup.ui.SetupWithUser
    public final int s1() {
        return C1987R.string._WAM_ALREADY_ASSIGNED_TITLE_;
    }

    @Override // com.withings.devicesetup.Setup.WithOverview
    public final int t0() {
        return C1987R.string._PULSE_PULSE_O2_;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i11) {
        parcel.writeParcelable(this.f54825a, i11);
    }
    ...
    @Override // com.withings.devicesetup.Setup.WithOverview
    public final int x0() {
        return C1987R.string._WAM01_OVERVIEW_MESSAGE_;
    }
    ...
    Wam01InstallSetup(Parcel parcel) {
        this.f54825a = (User) parcel.readParcelable(User.class.getClassLoader());
    }
