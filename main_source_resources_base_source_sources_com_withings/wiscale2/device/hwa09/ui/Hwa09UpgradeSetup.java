...
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u00032\u00020\u0004B\u0007¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lcom/withings/wiscale2/device/hwa09/ui/Hwa09UpgradeSetup;", "Lcom/withings/devicesetup/Setup;", "Lcom/withings/devicesetup/Setup$WithUpgrade;", "Lcom/withings/devicesetup/Setup$WithBatteryCheck;", "Lcom/withings/devicesetup/Setup$l;", "<init>", "()V", "HealthMate_prodRelease"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes5.dex */
public final class Hwa09UpgradeSetup implements Setup, Setup.WithUpgrade, Setup.WithBatteryCheck, Setup.l {
    public static final Parcelable.Creator<Hwa09UpgradeSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private DevicePictures f54546a;

    /* renamed from: b  reason: collision with root package name */
    private long[] f54547b;

    /* renamed from: c  reason: collision with root package name */
    private final g f54548c = h.b(b.f54549a);

    /* compiled from: Hwa09UpgradeSetup.kt */
    /* loaded from: classes5.dex */
    public static final class a implements Parcelable.Creator<Hwa09UpgradeSetup> {
        ...
        @Override // android.os.Parcelable.Creator
        public final Hwa09UpgradeSetup[] newArray(int i11) {
            return new Hwa09UpgradeSetup[i11];
        }
    }
    ...
    static final class b extends w implements ym0.a<e> {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final b f54549a = new w(0);
    ...
    public static final e a(Hwa09UpgradeSetup hwa09UpgradeSetup) {
        return (e) hwa09UpgradeSetup.f54548c.getValue();
    }

    private final Object g() {
        String url;
        DevicePictures devicePictures = this.f54546a;
    ...
    public final WppDeviceConversation M2(SetupConversation setupConversation) {
        ...
        return new WppDeviceConversation() { // from class: com.withings.wiscale2.device.hwa09.ui.Hwa09UpgradeSetup$getPreUpgradeConversation$1
            ...
            static final class a extends w implements q<Integer, long[], List<? extends ImageMetadata>, y> {
                ...
                /* renamed from: a  reason: collision with root package name */
                final /* synthetic */ Hwa09UpgradeSetup f54553a;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                a(Hwa09UpgradeSetup hwa09UpgradeSetup) {
                    super(3);
                    this.f54553a = hwa09UpgradeSetup;
                }
            ...
            public final void D() {
                ...
                e a11 = Hwa09UpgradeSetup.a(hwa09UpgradeSetup);
                ...
                if (cVar != null) {
                    ...
                    E(new WorkoutScreenGetConversation(new a(hwa09UpgradeSetup)));
                    return;
                }
    ...
    public final WppDeviceConversation V1(SetupConversation setupConversation) {
        ...
        return new WppDeviceConversation() { // from class: com.withings.wiscale2.device.hwa09.ui.Hwa09UpgradeSetup$getInitializingConversation$1
            ...
            public final void D() {
                Hwa09UpgradeSetup hwa09UpgradeSetup = Hwa09UpgradeSetup.this;
                Device f11 = Hwa09UpgradeSetup.a(hwa09UpgradeSetup).f(x().g());
                hwa09UpgradeSetup.f54546a = f11.getPictures();
                f11.getColor();
            }
        };
    }
    ...
    public final WppDeviceConversation d2(SetupConversation setupConversation) {
        ...
        return new WppDeviceConversation() { // from class: com.withings.wiscale2.device.hwa09.ui.Hwa09UpgradeSetup$getPostUpgradeConversation$1
            ...
            public final void D() {
                long[] jArr;
                boolean z5;
                jArr = Hwa09UpgradeSetup.this.f54547b;
                if (jArr != null) {
                    if (jArr.length == 0) {
                        z5 = true;
                    } else {
    ...
    @Override // com.withings.devicesetup.Setup
    public final int z2() {
        return C1987R.string.hwa09Setup_firmwareUpgradeSuccessTitle;
    }
}
