...
public class Wbs05NetworkSetup implements Setup, Setup.j {
    public static final Parcelable.Creator<Wbs05NetworkSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private String f54725a;

    /* loaded from: classes5.dex */
    final class a implements Parcelable.Creator<Wbs05NetworkSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wbs05NetworkSetup createFromParcel(Parcel parcel) {
            return new Wbs05NetworkSetup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public final Wbs05NetworkSetup[] newArray(int i11) {
            return new Wbs05NetworkSetup[i11];
        }
    }

    public Wbs05NetworkSetup(String str) {
        this.f54725a = str;
    }
    ...
    public final Object Z() {
        return Integer.valueOf(td0.a.a(this.f54725a).f37551f);
    }

    @Override // com.withings.devicesetup.Setup
    public final Object c1() {
        return Integer.valueOf(td0.a.a(this.f54725a).f37549d);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i11) {
        parcel.writeString(this.f54725a);
    }
    ...
    Wbs05NetworkSetup(Parcel parcel) {
        this.f54725a = parcel.readString();
    }
