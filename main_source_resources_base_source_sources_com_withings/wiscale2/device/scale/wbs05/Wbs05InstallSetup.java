...
public class Wbs05InstallSetup implements Setup.WithOverview, Setup.WithUpgrade, Setup.e, Setup.j, Setup.f, Setup.m, Setup.k, Setup.o, Setup.l {
    public static final Parcelable.Creator<Wbs05InstallSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private String f54724a;

    /* loaded from: classes5.dex */
    final class a implements Parcelable.Creator<Wbs05InstallSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wbs05InstallSetup createFromParcel(Parcel parcel) {
            return new Wbs05InstallSetup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public final Wbs05InstallSetup[] newArray(int i11) {
            return new Wbs05InstallSetup[i11];
        }
    }

    public Wbs05InstallSetup() {
    }
    ...
    public final Object N2() {
        return Integer.valueOf(td0.a.a(this.f54724a).f37550e);
    }
    ...
    public final Object Z() {
        return Integer.valueOf(td0.a.a(this.f54724a).f37551f);
    }
    ...
    public final int b() {
        return p.f67672b.a().d(5).I(this.f54724a);
    }

    @Override // com.withings.devicesetup.Setup
    public final Object c1() {
        return Integer.valueOf(td0.a.a(this.f54724a).f37549d);
    }
    ...
    public final void r0(SetupActivity setupActivity) {
        ...
        m11.c(c.a.e(setupActivity, f11, 5, setupActivity.S3(), true, false));
        m11.r();
    ...
    public final Intent s(Context context) {
        String string = context.getString(C1987R.string._WBS05_CONNECTION_HELPER_LINK_SEARCHING_);
    ...
    @Override // com.withings.devicesetup.Setup
    public final aj.b w() {
        return androidx.camera.camera2.internal.e.b(p.f67672b, 5);
    }
    ...
    Wbs05InstallSetup(Parcel parcel) {
        this.f54724a = parcel.readString();
    }
