...
import xp.g;
import yi.d;
/* compiled from: Wbs09NetworkSetup.kt */
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u00012\u00020\u0002¨\u0006\u0003"}, d2 = {"Lcom/withings/wiscale2/device/scale/wbs09/Wbs09NetworkSetup;", "Lcom/withings/devicesetup/Setup;", "Lcom/withings/devicesetup/Setup$j;", "HealthMate_prodRelease"}, k = 1, mv = {1, 9, 0})
/* loaded from: classes5.dex */
public final class Wbs09NetworkSetup implements Setup, Setup.j {
    public static final Parcelable.Creator<Wbs09NetworkSetup> CREATOR = new Object();
    ...
    /* compiled from: Wbs09NetworkSetup.kt */
    /* loaded from: classes5.dex */
    public static final class a implements Parcelable.Creator<Wbs09NetworkSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wbs09NetworkSetup createFromParcel(Parcel parcel) {
            u.j(parcel, "parcel");
            return new Wbs09NetworkSetup(parcel.readString());
        }

        @Override // android.os.Parcelable.Creator
        public final Wbs09NetworkSetup[] newArray(int i11) {
            return new Wbs09NetworkSetup[i11];
        }
    }

    public Wbs09NetworkSetup(String str) {
        this.f54743a = str;
    }
