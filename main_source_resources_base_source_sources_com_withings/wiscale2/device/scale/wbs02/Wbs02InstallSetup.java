...
public class Wbs02InstallSetup implements Setup.WithOverview, Setup.WithUpgradeDependingOnNetworkConfiguration, Setup.e, Setup.f, Setup.m, Setup.k, Setup.o, Setup.l {
    public static final Parcelable.Creator<Wbs02InstallSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private String f54715a;

    /* loaded from: classes5.dex */
    final class a implements Parcelable.Creator<Wbs02InstallSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wbs02InstallSetup createFromParcel(Parcel parcel) {
            return new Wbs02InstallSetup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public final Wbs02InstallSetup[] newArray(int i11) {
            return new Wbs02InstallSetup[i11];
        }
    }

    public Wbs02InstallSetup() {
    }

    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int B0() {
        return C1987R.string._WBS02_UPGRADE_MESSAGE_CHECKING_FIRMWARE_;
    }
    ...
    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int G1() {
        return C1987R.string._WBS02_UPGRADE_TITLE_DOWNLOADING_;
    }
    ...
    public final Intent M1(Context context) {
        return e.c(C1987R.string._SCALE_WS50_URL_, context);
    }
    ...
    public final Object N2() {
        return Integer.valueOf(qd0.a.a(this.f54715a).f37550e);
    }
    ...
    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int R0() {
        return C1987R.string._WBS02_UPGRADE_TITLE_CHECKING_FIRMWARE_;
    }
    ...
    public final Object Z() {
        return Integer.valueOf(qd0.a.a(this.f54715a).f37551f);
    }
    ...
    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int a1() {
        return C1987R.string._WBS02_UPGRADE_TITLE__s_UPGRADING_;
    }

    @Override // com.withings.devicesetup.Setup.l
    public final int b() {
        return p.f67672b.a().d(4).I(this.f54715a);
    }

    @Override // com.withings.devicesetup.Setup
    public final Object c1() {
        return Integer.valueOf(qd0.a.a(this.f54715a).f37549d);
    }

    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int c2() {
        return C1987R.string._WBS02_UPGRADE_TITLE_REBOOTING_;
    }
    ...
    @Override // com.withings.devicesetup.Setup.l
    public final int f() {
        return C1987R.string._WBS02_CONNECTION_HELPER_SEARCHING_;
    }
    ...
    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int k0() {
        return C1987R.string._WBS02_UPGRADE_MESSAGE_UPGRADING_;
    }
    ...
    public final Intent s(Context context) {
        String string = context.getString(C1987R.string._WBS02_CONNECTION_HELPER_LINK_SEARCHING_);
        return HMWebActivity.f35395c.c(context, context.getString(C1987R.string._HELP_CENTER_), string);
    }

    @Override // com.withings.devicesetup.Setup.WithOverview
    public final int t0() {
        return C1987R.string._WBS02_OVERVIEW_TITLE_;
    }
    ...
    @Override // com.withings.devicesetup.Setup
    public final aj.b w() {
        return androidx.camera.camera2.internal.e.b(p.f67672b, 4);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i11) {
        parcel.writeString(this.f54715a);
    }
    ...
    @Override // com.withings.devicesetup.Setup.WithOverview
    public final int x0() {
        return C1987R.string._WBS02_OVERVIEW_MESSAGE_;
    }

    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int y0() {
        return C1987R.string._WBS02_UPGRADE_MESSAGE_REBOOTING_;
    }

    @Override // com.withings.devicesetup.Setup.WithUpgrade
    public final int y2() {
        return C1987R.string._WBS02_UPGRADE_MESSAGE_DOWNLOADING_;
    }
    ...
    Wbs02InstallSetup(Parcel parcel) {
        this.f54715a = parcel.readString();
    }
