...
public class Wbs06InstallSetup implements Setup.WithOverview, Setup.WithUpgrade, Setup.e, Setup.f, Setup.j, Setup.m, Setup.k, Setup.o, Setup.l {
    public static final Parcelable.Creator<Wbs06InstallSetup> CREATOR = new Object();
    ...
    /* loaded from: classes5.dex */
    final class a implements Parcelable.Creator<Wbs06InstallSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wbs06InstallSetup createFromParcel(Parcel parcel) {
            return new Wbs06InstallSetup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public final Wbs06InstallSetup[] newArray(int i11) {
            return new Wbs06InstallSetup[i11];
        }
    }
    ...
    public final Object N2() {
        return Integer.valueOf(ud0.a.a(this.f54730a).f37550e);
    }
    ...
    public final Object Z() {
        return Integer.valueOf(ud0.a.a(this.f54730a).f37551f);
    }
    ...
    public final int b() {
        return p.f67672b.a().d(7).I(this.f54730a);
    }

    @Override // com.withings.devicesetup.Setup
    public final Object c1() {
        return Integer.valueOf(ud0.a.a(this.f54730a).f37549d);
    }
    ...
    public final void r0(SetupActivity setupActivity) {
        ...
        m11.c(c.a.e(setupActivity, f11, 7, setupActivity.S3(), true, false));
        m11.r();
    ...
    public final Intent s(Context context) {
        String string = context.getString(C1987R.string._WBS06_CONNECTION_HELPER_LINK_SEARCHING_);
    ...
    @Override // com.withings.devicesetup.Setup
    public final aj.b w() {
        return androidx.camera.camera2.internal.e.b(p.f67672b, 7);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i11) {
        parcel.writeString(this.f54730a);
    }
    ...
    Wbs06InstallSetup(Parcel parcel) {
        vf.c cVar;
        cVar = vf.c.f103617d;
        if (cVar != null) {
            this.f54731b = cVar;
            this.f54730a = parcel.readString();
            return;
        }
        throw new IllegalArgumentException("You must call init before".toString());
    }
