...
public class Wbs03UpgradeSetup implements Setup.WithUpgrade {
    public static final Parcelable.Creator<Wbs03UpgradeSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private String f54720a;

    /* loaded from: classes5.dex */
    final class a implements Parcelable.Creator<Wbs03UpgradeSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wbs03UpgradeSetup createFromParcel(Parcel parcel) {
            return new Wbs03UpgradeSetup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public final Wbs03UpgradeSetup[] newArray(int i11) {
            return new Wbs03UpgradeSetup[i11];
        }
    }

    public Wbs03UpgradeSetup(String str) {
        this.f54720a = str;
    }
    ...
    @Override // com.withings.devicesetup.Setup
    public final int J() {
        return C1987R.string._WBS03_UPGRADE_MESSAGE_SUCCESS_;
    }
    ...
    public final Object N2() {
        return Integer.valueOf(rd0.a.a(this.f54720a).f37550e);
    }
    ...
    public final Object Z() {
        return Integer.valueOf(rd0.a.a(this.f54720a).f37551f);
    }
    ...
    public final Object c1() {
        return Integer.valueOf(rd0.a.a(this.f54720a).f37549d);
    }
    ...
    @Override // com.withings.devicesetup.Setup
    public final int z2() {
        return C1987R.string._WBS03_UPGRADE_TITLE_SUCCESS_;
    }

    Wbs03UpgradeSetup(Parcel parcel) {
        this.f54720a = parcel.readString();
    }
