...
public class Wbs03NetworkSetup implements Setup, Setup.j {
    public static final Parcelable.Creator<Wbs03NetworkSetup> CREATOR = new Object();

    /* renamed from: a  reason: collision with root package name */
    private String f54719a;

    /* loaded from: classes5.dex */
    final class a implements Parcelable.Creator<Wbs03NetworkSetup> {
        @Override // android.os.Parcelable.Creator
        public final Wbs03NetworkSetup createFromParcel(Parcel parcel) {
            return new Wbs03NetworkSetup(parcel);
        }

        @Override // android.os.Parcelable.Creator
        public final Wbs03NetworkSetup[] newArray(int i11) {
            return new Wbs03NetworkSetup[i11];
        }
    }

    public Wbs03NetworkSetup(String str) {
        this.f54719a = str;
    }
    ...
    public final Object Z() {
        return Integer.valueOf(rd0.a.a(this.f54719a).f37551f);
    }

    @Override // com.withings.devicesetup.Setup
    public final Object c1() {
        return Integer.valueOf(rd0.a.a(this.f54719a).f37549d);
    }
    ...
    Wbs03NetworkSetup(Parcel parcel) {
        this.f54719a = parcel.readString();
    }
