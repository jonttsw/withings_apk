...
final class l extends kotlin.jvm.internal.w implements ym0.p<androidx.compose.runtime.a, Integer, nm0.y> {
    ...
    final /* synthetic */ WeatherAirQualityActivity f53874a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(WeatherAirQualityActivity weatherAirQualityActivity) {
        super(2);
        this.f53874a = weatherAirQualityActivity;
    }
    ...
    public final nm0.y invoke(androidx.compose.runtime.a aVar, Integer num) {
        ...
        if ((num.intValue() & 11) == 2 && aVar2.h()) {
            ...
            WeatherAirQualityActivity.z3(this.f53874a, aVar2, 8);
        }
