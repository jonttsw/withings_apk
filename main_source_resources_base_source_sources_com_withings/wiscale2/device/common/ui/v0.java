...
final class v0 extends kotlin.jvm.internal.w implements ym0.p<fl.o, DeviceModel, String> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Application f54109a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v0(Application application) {
        super(2);
        this.f54109a = application;
    }
    ...
    public final String invoke(fl.o oVar, DeviceModel deviceModel) {
        ...
        String string = application.getString(C1987R.string.deviceSharing_title);
