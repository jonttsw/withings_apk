...
final class x extends kotlin.jvm.internal.w implements ym0.l<Integer, nm0.y> {
    ...
    final /* synthetic */ HighLowHRSettingsActivity f52315a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(HighLowHRSettingsActivity highLowHRSettingsActivity) {
        super(1);
        this.f52315a = highLowHRSettingsActivity;
    }
    ...
    public final nm0.y invoke(Integer num) {
        tb0.x J3;
        String K3;
        HighLowHRSettingsActivity highLowHRSettingsActivity = this.f52315a;
        J3 = highLowHRSettingsActivity.J3();
        K3 = highLowHRSettingsActivity.K3(num);
        J3.f99601d.setValue(K3);
