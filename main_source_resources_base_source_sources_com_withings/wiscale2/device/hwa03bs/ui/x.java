...
public final class x extends kotlin.jvm.internal.w implements ym0.p<Explanation, View, nm0.y> {
    ...
    final /* synthetic */ Hwa03PostInstallActivity f54280a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(Hwa03PostInstallActivity hwa03PostInstallActivity) {
        super(2);
        this.f54280a = hwa03PostInstallActivity;
    }
