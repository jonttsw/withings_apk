...
public final class Hwa06Connector implements e.c, e.d, a.c, t.a {

    /* renamed from: h  reason: collision with root package name */
    private static final AutoSyncReceiver f54288h = new AutoSyncReceiver();

    /* renamed from: i  reason: collision with root package name */
    public static final /* synthetic */ int f54289i = 0;

    /* renamed from: a  reason: collision with root package name */
    private Device f54290a;

    /* renamed from: b  reason: collision with root package name */
    private final Context f54291b;

    /* renamed from: c  reason: collision with root package name */
    private final u70.a f54292c;

    /* renamed from: d  reason: collision with root package name */
    private final w f54293d;
    ...
    /* compiled from: Hwa06Connector.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/withings/wiscale2/device/hwa06/Hwa06Connector$AutoSyncReceiver;", "Landroid/content/BroadcastReceiver;", "<init>", "()V", "HealthMate_prodRelease"}, k = 1, mv = {1, 9, 0})
    /* loaded from: classes5.dex */
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            if (u70.a.b().d(60000L)) {
                ...
                if (f11 != null) {
                    ...
                    if (eVar != null) {
                        e.c f12 = eVar.f(f11);
                        if (f12 instanceof Hwa06Connector) {
                            ((Hwa06Connector) f12).d();
                            return;
                        }
                        return;
                    }
                ...
                int i11 = Hwa06Connector.f54289i;
                a.b(context, null);
            }
        }
    }
    ...
    public static final class a {
        public static final void a(Context context, i iVar) {
            int i11 = Hwa06Connector.f54289i;
            androidx.core.content.a.registerReceiver(context, Hwa06Connector.f54288h, new IntentFilter("com.withings.wiscale2.device.hwa06.autosync"), 4);
        ...
        public static final void b(Context context, i iVar) {
            int i11 = Hwa06Connector.f54289i;
            b.w(context, Hwa06Connector.f54288h);
            Object systemService = context.getSystemService("alarm");
            u.h(systemService, "null cannot be cast to non-null type android.app.AlarmManager");
        ...
        private static PendingIntent c(Context context, i iVar) {
            int i11;
            Intent intent = new Intent("com.withings.wiscale2.device.hwa06.autosync").setPackage(context.getPackageName());
    ...
    public Hwa06Connector(Context context, Device device) {
        u70.a b10 = u70.a.b();
        u.i(b10, "get(...)");
        w w11 = w.w();
        u.i(w11, "get(...)");
    ...
    private final void e() {
        ...
        d b10 = jl.a.b(this.f54290a);
        w wVar = this.f54293d;
        wVar.getClass();
        k<?> u11 = wVar.u(b10, connectionInitialisationConversation, ConnectionInitialisationConversation.class);
        this.f54295f = u11;
        u11.r();
        x70.b.c(this, this.f54290a.getMacAddress(), "Submitting connection", new Object[0]);
    }
    ...
    public final void d() {
        ...
        this.f54294e = u11;
        u11.r();
        x70.b.c(this, this.f54290a.getMacAddress(), "Submitting synchronisation", new Object[0]);
    }

    @Override // u70.a.c
    public final void f2(long j5) {
        x70.b.c(this, this.f54290a.getMacAddress(), "App enters foreground", new Object[0]);
        d();
    }
    ...
    public final void start() {
        ...
        this.f54292c.a(this);
        i macAddress = this.f54290a.getMacAddress();
        u.i(macAddress, "getMacAddress(...)");
        a.a(this.f54291b, macAddress);
        this.f54293d.E(this.f54290a.getMacAddress()).d(this);
        this.f54296g = true;
        e();
        d();
    }
    ...
    public final void stop() {
        ...
        wVar.s(macAddress);
        this.f54292c.h(this);
        a.b(this.f54291b, this.f54290a.getMacAddress());
        wVar.E(this.f54290a.getMacAddress()).f(this);
        this.f54296g = false;
    }
