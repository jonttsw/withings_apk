...
public final class x extends kotlin.jvm.internal.w implements ym0.p<Explanation, View, nm0.y> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Hwa06PostInstallActivity f54366a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public x(Hwa06PostInstallActivity hwa06PostInstallActivity) {
        super(2);
        this.f54366a = hwa06PostInstallActivity;
    }
