...
public final class w extends kotlin.jvm.internal.w implements ym0.p<Explanation, View, nm0.y> {
    ...
    final /* synthetic */ Hwa06PostInstallActivity f54365a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public w(Hwa06PostInstallActivity hwa06PostInstallActivity) {
        super(2);
        this.f54365a = hwa06PostInstallActivity;
    }
