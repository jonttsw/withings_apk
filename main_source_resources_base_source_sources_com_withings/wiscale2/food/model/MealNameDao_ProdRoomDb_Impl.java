...
public final class MealNameDao_ProdRoomDb_Impl implements MealNameDao {
    ...
    public MealNameDao_ProdRoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfMealName = new k<MealName>(roomDatabase) { // from class: com.withings.wiscale2.food.model.MealNameDao_ProdRoomDb_Impl.1
            ...
            public void bind(f fVar, MealName mealName) {
                ...
                b bVar = MealNameDao_ProdRoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar2 = MealNameDao_ProdRoomDb_Impl.this.__commonRoomConverter;
        ...
        this.__deletionAdapterOfMealName = new j<MealName>(roomDatabase) { // from class: com.withings.wiscale2.food.model.MealNameDao_ProdRoomDb_Impl.2
            /* JADX INFO: Access modifiers changed from: protected */
        ...
        this.__updateAdapterOfMealName = new j<MealName>(roomDatabase) { // from class: com.withings.wiscale2.food.model.MealNameDao_ProdRoomDb_Impl.3
            @Override // androidx.room.j, androidx.room.h0
            protected String createQuery() {
