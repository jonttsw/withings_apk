...
public final class MealDao_ProdRoomDb_Impl implements MealDao {
    ...
    public MealDao_ProdRoomDb_Impl(RoomDatabase roomDatabase) {
        this.__db = roomDatabase;
        this.__insertionAdapterOfMeal = new k<Meal>(roomDatabase) { // from class: com.withings.wiscale2.food.model.MealDao_ProdRoomDb_Impl.1
            ...
            public void bind(f fVar, Meal meal) {
                ...
                b bVar = MealDao_ProdRoomDb_Impl.this.__commonRoomConverter;
                ...
                b bVar2 = MealDao_ProdRoomDb_Impl.this.__commonRoomConverter;
        ...
        this.__preparedStmtOfDeleteByUserId = new h0(roomDatabase) { // from class: com.withings.wiscale2.food.model.MealDao_ProdRoomDb_Impl.2
            @Override // androidx.room.h0
            public String createQuery() {
                return "DELETE FROM meal WHERE userId = ?";
            }
        };
        this.__preparedStmtOfDeleteByMealNameId = new h0(roomDatabase) { // from class: com.withings.wiscale2.food.model.MealDao_ProdRoomDb_Impl.3
            @Override // androidx.room.h0
            public String createQuery() {
            ...
            try {
                ...
                try {
                    ...
                    if (c12.moveToFirst()) {
                        ...
                        try {
                            mealDao_ProdRoomDb_Impl.__commonRoomConverter.getClass();
