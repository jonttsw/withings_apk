...
public final class WorkoutPauseLiveData$onWorkoutPauseReceived$1 extends w implements l<List<? extends Vasistas>, y> {
    final /* synthetic */ d0 $vasistasLiveData;
    final /* synthetic */ WorkoutPauseLiveData this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WorkoutPauseLiveData$onWorkoutPauseReceived$1(WorkoutPauseLiveData workoutPauseLiveData, d0 d0Var) {
        super(1);
        this.this$0 = workoutPauseLiveData;
        this.$vasistasLiveData = d0Var;
    }
    ...
    public final void invoke2(List<Vasistas> list) {
        this.this$0.removeSource(this.$vasistasLiveData);
        this.this$0.postValue(list);
    }
}
