...
final class f extends w implements r<l0.c, androidx.navigation.d, androidx.compose.runtime.a, Integer, y> {
    ...
    final /* synthetic */ RequestLocationPermissionAndSettingsActivity f48778a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f(RequestLocationPermissionAndSettingsActivity requestLocationPermissionAndSettingsActivity) {
        super(4);
        this.f48778a = requestLocationPermissionAndSettingsActivity;
    }
    ...
    public final y invoke(l0.c cVar, androidx.navigation.d dVar, androidx.compose.runtime.a aVar, Integer num) {
        ...
        u.j(it, "it");
        oa0.c.a(new e(this.f48778a), aVar, 0);
        return y.f85009a;
    }
}
