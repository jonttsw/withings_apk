...
public final class a2 extends kotlin.jvm.internal.w implements ym0.a<User> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ t1.e f60879a;
    ...
    public final User invoke() {
        t1.e eVar = this.f60879a;
        eVar.getClass();
        boolean isAssignableFrom = Parcelable.class.isAssignableFrom(User.class);
        Fragment fragment = eVar.f61520b;
        if (isAssignableFrom) {
