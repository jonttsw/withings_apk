...
import com.withings.clinicalstudy.repository.PatientSessionDao_RoomDb_Impl;
import com.withings.ecg.model.HeartSignalDao;
import com.withings.ecg.model.HeartSignalDao_RoomDb_Impl;
import com.withings.factor.local.dao.FactorDao;
import com.withings.factor.local.dao.FactorDao_RoomDb_Impl;
import com.withings.features.platform.model.PlatformFeatureDao;
import com.withings.features.platform.model.PlatformFeatureDao_RoomDb_Impl;
import com.withings.features.platform.model.PlatformTagDao;
import com.withings.features.platform.model.PlatformTagDao_RoomDb_Impl;
import com.withings.healthplus.navigation.ui.navigation.NavigationArguments;
import com.withings.leaderboard.repositories.data.LeaderboardDAO;
import com.withings.leaderboard.repositories.data.LeaderboardDAO_RoomDb_Impl;
import com.withings.library.authentication.api.ConstantsWs;
import com.withings.location.repository.data.db.RoomGpsLocationDao;
import com.withings.location.repository.data.db.RoomGpsLocationDao_RoomDb_Impl;
...
import com.withings.note.model.NoteGroupDao_RoomDb_Impl;
import com.withings.prediction.local.dao.PredictionDao;
import com.withings.prediction.local.dao.PredictionDao_RoomDb_Impl;
import com.withings.screen.repository.data.db.DeviceScreenContentDao;
import com.withings.screen.repository.data.db.DeviceScreenContentDao_RoomDb_Impl;
import com.withings.screen.repository.data.db.DeviceScreenDao;
import com.withings.screen.repository.data.db.DeviceScreenDao_RoomDb_Impl;
import com.withings.screen.repository.data.db.DeviceScreensGroupDao;
import com.withings.screen.repository.data.db.DeviceScreensGroupDao_RoomDb_Impl;
import com.withings.target.data.TargetDAO;
import com.withings.target.data.TargetDAO_RoomDb_Impl;
...
import com.withings.wiscale2.food.model.MealDao_RoomDb_Impl;
import com.withings.wiscale2.food.model.MealNameDao;
import com.withings.wiscale2.food.model.MealNameDao_RoomDb_Impl;
...
public final class RoomDb_Impl extends RoomDb {
    ...
    final class a extends c0.a {
        a() {
            super(ConstantsWs.MEASURE_TYPE_BREATHING_EVENT_PROBABILITY);
        }
        ...
        public final void b(a9.c cVar) {
            ...
            androidx.work.impl.g.c(cVar, "DROP TABLE IF EXISTS `bookmarkPreview`", "DROP TABLE IF EXISTS `ActirecCategoryDetection`", "DROP TABLE IF EXISTS `task_content`", "DROP TABLE IF EXISTS `HealthScore`");
            ...
            List<RoomDatabase.b> list = ((RoomDatabase) RoomDb_Impl.this).f18109g;
            if (list != null) {
        ...
        public final void d(a9.c cVar) {
            ...
            ((RoomDatabase) roomDb_Impl).f18103a = cVar;
            cVar.l("PRAGMA foreign_keys = ON");
            roomDb_Impl.u(cVar);
            List<RoomDatabase.b> list = ((RoomDatabase) roomDb_Impl).f18109g;
            if (list != null) {
                for (RoomDatabase.b bVar : list) {
                    bVar.a(cVar);
                }
        ...
        public final c0.b f(a9.c cVar) {
            ...
            hashMap30.put(NavigationArguments.USER_ID, new c.a(NavigationArguments.USER_ID, "INTEGER", null, 1, 1, true));
            hashMap30.put("workoutCategory", new c.a("workoutCategory", "INTEGER", null, 2, 1, true));
            x8.c cVar31 = new x8.c("ActirecCategoryDetection", hashMap30, l0.c(hashMap30, StreamManagement.Enabled.ELEMENT, new c.a(StreamManagement.Enabled.ELEMENT, "INTEGER", null, 0, 1, true), 0), new HashSet(0));
            x8.c a43 = x8.c.a(cVar, "ActirecCategoryDetection");
            ...
            hashMap31.put(NavigationArguments.CONTENT_ID, new c.a(NavigationArguments.CONTENT_ID, "TEXT", null, 1, 1, true));
            hashMap31.put("relatedProgramId", new c.a("relatedProgramId", "INTEGER", HealthConstants.FoodIntake.UNIT_TYPE_NOT_DEFINED, 2, 1, true));
            hashMap31.put("lastUpdate", new c.a("lastUpdate", "INTEGER", null, 0, 1, true));
            x8.c cVar32 = new x8.c("task_content", hashMap31, l0.c(hashMap31, "content", new c.a("content", "TEXT", null, 0, 1, true), 0), new HashSet(0));
            x8.c a44 = x8.c.a(cVar, "task_content");
    ...
    protected final androidx.room.p f() {
        ...
        return new androidx.room.p(this, hashMap, hashMap2, "DeviceScreen", "DeviceScreenContent", "Event", "WorkoutLocation", "EcgMeasurement", "HealthmateSessionData", "Insight", "leaderboard", "Meal", "MealName", "Mood", "PartnerExchangeLastUpdate", "PlatformFeature", "HealthAttributes", "NoteEntity", "NoteGroup", "Tag", "Target", "Track", "VasistasSource", "PatientSession", "program_task_preview", "DeviceScreensGroup", "mission_task_preview", "program", "program_enrolled", "program_iteration", "bookmark", "bookmarkPreview", "ActirecCategoryDetection", "task_content", "HealthScore", "libraryFilter", "libraryPreviewContent", "libraryPreviewContentWithFilter", "Plan", "prediction", "HealthInsight", "factor");
    }
    ...
    public final List i(LinkedHashMap linkedHashMap) {
        ...
        arrayList.add(new w8.b(81, 82));
        arrayList.add(new w8.b(82, 83));
        arrayList.add(new v(1));
        arrayList.add(new w(1));
        arrayList.add(new com.withings.wiscale2.data.a(2));
        ...
        arrayList.add(new com.withings.wiscale2.data.a(1));
        ...
        arrayList.add(new w8.b(124, 125));
        arrayList.add(new z());
        return arrayList;
    }
    ...
    protected final Map<Class<?>, List<Class<?>>> p() {
        ...
        hashMap.put(HeartSignalDao.class, HeartSignalDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(yb0.a.class, Collections.emptyList());
        hashMap.put(RoomGpsLocationDao.class, RoomGpsLocationDao_RoomDb_Impl.getRequiredConverters());
        ...
        hashMap.put(LeaderboardDAO.class, LeaderboardDAO_RoomDb_Impl.getRequiredConverters());
        hashMap.put(MealDao.class, MealDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(MealNameDao.class, MealNameDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(nx.b.class, Collections.emptyList());
        hashMap.put(lx.a.class, Collections.emptyList());
        hashMap.put(NoteGroupDao.class, NoteGroupDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(u10.x.class, Collections.emptyList());
        hashMap.put(PatientSessionDao.class, PatientSessionDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(PlatformTagDao.class, PlatformTagDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(PlatformFeatureDao.class, PlatformFeatureDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(ei0.m.class, Collections.emptyList());
        hashMap.put(TargetDAO.class, TargetDAO_RoomDb_Impl.getRequiredConverters());
        ...
        hashMap.put(DeviceScreenDao.class, DeviceScreenDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(DeviceScreenContentDao.class, DeviceScreenContentDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(DeviceScreensGroupDao.class, DeviceScreensGroupDao_RoomDb_Impl.getRequiredConverters());
        ...
        hashMap.put(PredictionDao.class, PredictionDao_RoomDb_Impl.getRequiredConverters());
        hashMap.put(fw.a.class, Collections.emptyList());
        hashMap.put(FactorDao.class, FactorDao_RoomDb_Impl.getRequiredConverters());
        return hashMap;
    }
}
