...
public final class BrowseProgramActivity$special$$inlined$viewBindingActivity$1 extends w implements l<ComponentActivity, tb0.d> {
    final /* synthetic */ int $viewBindingRootId;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BrowseProgramActivity$special$$inlined$viewBindingActivity$1(int i11) {
        super(1);
        this.$viewBindingRootId = i11;
    }

    @Override // ym0.l
    public final tb0.d invoke(ComponentActivity activity) {
