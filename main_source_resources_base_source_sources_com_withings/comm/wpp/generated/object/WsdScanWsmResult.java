...
public class WsdScanWsmResult extends h {
    ...
    public WsdScanWsmResult setBlVersion(long j5) {
        this.blVersion = j5;
        return this;
    }

    public WsdScanWsmResult setHardVersion(long j5) {
        this.hardVersion = j5;
        return this;
    }

    public WsdScanWsmResult setMac(String str) {
        this.mac = str;
        return this;
    }

    public WsdScanWsmResult setMfgId(String str) {
        this.mfgId = str;
        return this;
    }

    public WsdScanWsmResult setName(String str) {
        this.name = str;
        return this;
    }

    public WsdScanWsmResult setPid(int i11) {
        this.pid = i11;
        return this;
    }

    public WsdScanWsmResult setRescueVersion(long j5) {
        this.rescueVersion = j5;
        return this;
    }

    public WsdScanWsmResult setSecret(String str) {
        this.secret = str;
        return this;
    }

    public WsdScanWsmResult setSoftVersion(long j5) {
        this.softVersion = j5;
        return this;
    }

    public WsdScanWsmResult setUserid(long j5) {
        this.userid = j5;
        return this;
    }

    public WsdScanWsmResult setVid(int i11) {
        this.vid = i11;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("WsdScanWsmResult(");
        ...
        sb2.append(", ");
        sb2.append("rescueVersion = " + this.rescueVersion);
        sb2.append(", ");
