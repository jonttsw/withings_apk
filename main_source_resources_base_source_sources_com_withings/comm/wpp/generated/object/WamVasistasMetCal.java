...
public class WamVasistasMetCal extends h {
    public int calories;
    public int met;
    ...
    public short getType() {
        return Wpp.TYPE_WAM_VASISTAS_MET_CAL;
    }
    ...
    public WamVasistasMetCal setCalories(int i11) {
        this.calories = i11;
        return this;
    }

    public WamVasistasMetCal setMet(int i11) {
        this.met = i11;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb2 = new StringBuilder("WamVasistasMetCal(");
